...
public class TC_0016_CP_EndToEnd_Verify_Res_EnterCompanyDetails_SingleProd_Registered_BookingPass extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0016_CP_EndToEnd_Verify_Res_EnterCompanyDetails_SingleProd_Registered_BookingPass.class.getName());

	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0016_CP_EndToEnd_Verify_Res_EnterCompanyDetails_SingleProd_Registered_BookingPass";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=433,dataProvider = "getDataForTestCaseName", testName = "TC_0016_CP_EndToEnd_Verify_Res_EnterCompanyDetails_SingleProd_Registered_BookingPass", description ="TC_0016_CP_EndToEnd_Verify_Res_EnterCompanyDetails_SingleProd_Registered_BookingPass")
	public void ssp_TC_0016_CP_EndToEnd_Verify_Res_EnterCompanyDetails_SingleProd_Registered_BookingPass(Hashtable<String, String> data)throws Throwable {
