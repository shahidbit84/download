...
public class TC_0009_CP_EndToEnd_Verify_Res_MultipleLicensePlate_SingleProd_Annonymous_BookingPass_Res extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0009_CP_EndToEnd_Verify_Res_MultipleLicensePlate_SingleProd_Annonymous_BookingPass_Res.class.getName());

	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0009_CP_EndToEnd_Verify_Res_MultipleLicensePlate_SingleProd_Annonymous_BookingPass_Res";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=410,dataProvider = "getDataForTestCaseName", testName = "TC_0009_CP_EndToEnd_Verify_Res_MultipleLicensePlate_SingleProd_Annonymous_BookingPass_Res", description ="TC_0009_CP_EndToEnd_Verify_Res_MultipleLicensePlate_SingleProd_Annonymous_BookingPass_Res")
	public void ssp_TC_0009_CP_EndToEnd_Verify_Res_MultipleLicensePlate_SingleProd_Annonymous_BookingPass_Res(Hashtable<String, String> data)throws Throwable {
