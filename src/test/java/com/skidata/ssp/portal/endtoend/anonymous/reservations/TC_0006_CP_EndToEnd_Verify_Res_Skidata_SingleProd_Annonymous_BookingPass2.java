...
public class TC_0006_CP_EndToEnd_Verify_Res_Skidata_SingleProd_Annonymous_BookingPass2 extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0006_CP_EndToEnd_Verify_Res_Skidata_SingleProd_Annonymous_BookingPass2.class.getName());

	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0006_CP_EndToEnd_Verify_Res_Skidata_SingleProd_Annonymous_BookingPass";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=408,dataProvider = "getDataForTestCaseName", testName = "TC_0006_CP_EndToEnd_Verify_Res_Skidata_SingleProd_Annonymous_BookingPass", description ="TC_0006_CP_EndToEnd_Verify_Res_Skidata_SingleProd_Annonymous_BookingPass")
	public void ssp_TC_0006_CP_EndToEnd_Verify_Res_Skidata_SingleProd_Annonymous_BookingPass(Hashtable<String, String> data)throws Throwable {
		...
		try {
			...
			init("headless", portalURL,testName,screenRecording);
			...
			sspHomePage.searchParkingLocationsAndSelect2(data.get("EnterLocationNameToSearch"),data.get("SelectLocationAddress"));
