...
public class TC_0005_CP_EndToEnd_Verify_Subscription_LicensePlate_SingleProd_BookingPass extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0005_CP_EndToEnd_Verify_Subscription_LicensePlate_SingleProd_BookingPass.class.getName());

	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0005_CP_EndToEnd_Verify_Subscription_LicensePlate_SingleProd_BookingPass";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=430,dataProvider = "getDataForTestCaseName", testName = "TC_0005_CP_EndToEnd_Verify_Subscription_LicensePlate_SingleProd_BookingPass", description ="TC_0005_CP_EndToEnd_Verify_Subscription_LicensePlate_SingleProd_BookingPass")
	public void ssp_TC_0005_CP_EndToEnd_Verify_Subscription_LicensePlate_SingleProd_BookingPass(Hashtable<String, String> data)throws Throwable {
