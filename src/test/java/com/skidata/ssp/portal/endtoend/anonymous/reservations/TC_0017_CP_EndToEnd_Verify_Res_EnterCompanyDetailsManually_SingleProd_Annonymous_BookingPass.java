 ...
 *
 */
package com.skidata.ssp.portal.endtoend.anonymous.reservations;
...
public class TC_0017_CP_EndToEnd_Verify_Res_EnterCompanyDetailsManually_SingleProd_Annonymous_BookingPass extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0017_CP_EndToEnd_Verify_Res_EnterCompanyDetailsManually_SingleProd_Annonymous_BookingPass.class.getName());

	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0017_CP_EndToEnd_Verify_Res_EnterCompanyDetailsManually_SingleProd_Annonymous_BookingPass";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=434,dataProvider = "getDataForTestCaseName", testName = "TC_0017_CP_EndToEnd_Verify_Res_EnterCompanyDetailsManually_SingleProd_Annonymous_BookingPass", description ="TC_0017_CP_EndToEnd_Verify_Res_EnterCompanyDetailsManually_SingleProd_Annonymous_BookingPass")
	public void ssp_TC_0017_CP_EndToEnd_Verify_Res_EnterCompanyDetailsManually_SingleProd_Annonymous_BookingPass(Hashtable<String, String> data)throws Throwable {
		...
		try {
			...
			sspCheckoutPage.enterCompanyAddressComplete(data.get("CompanyName"),data.get("OtherInformation"),data.get("Vat"),
					data.get("Country"),data.get("Address"),data.get("Phone"), 
					data.get("Company_AddLine1"),data.get("Company_AddLine2"),
					data.get("Company_Town"),data.get("Company_State"),data.get("Company_PostCode"));
			...
			String  bookingID = sspBookingConfirmationPage.getBookingIDAnonymous();
