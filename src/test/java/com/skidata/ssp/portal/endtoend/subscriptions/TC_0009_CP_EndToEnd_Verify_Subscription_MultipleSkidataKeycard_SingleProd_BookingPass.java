...
public class TC_0009_CP_EndToEnd_Verify_Subscription_MultipleSkidataKeycard_SingleProd_BookingPass extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0009_CP_EndToEnd_Verify_Subscription_MultipleSkidataKeycard_SingleProd_BookingPass.class.getName());

	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0009_CP_EndToEnd_Verify_Subscription_MultipleSkidataKeycard_SingleProd_BookingPass";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=426,dataProvider = "getDataForTestCaseName", testName = "TC_0009_CP_EndToEnd_Verify_Subscription_MultipleSkidataKeycard_SingleProd_BookingPass", description ="TC_0009_CP_EndToEnd_Verify_Subscription_MultipleSkidataKeycard_SingleProd_BookingPass")
	public void ssp_TC_0009_CP_EndToEnd_Verify_Subscription_MultipleSkidataKeycard_SingleProd_BookingPass(Hashtable<String, String> data)throws Throwable {
