...
public class TC_0002_CP_EndToEnd_Verify_Res_DeisterTag_SingleProd_Annonymous_BookingPass extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0002_CP_EndToEnd_Verify_Res_DeisterTag_SingleProd_Annonymous_BookingPass.class.getName());

	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0002_CP_EndToEnd_Verify_Res_DeisterTag_SingleProd_Annonymous_BookingPass";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=405,dataProvider = "getDataForTestCaseName", testName = "TC_0002_CP_EndToEnd_Verify_Res_DeisterTag_SingleProd_Annonymous_BookingPass", description ="TC_0002_CP_EndToEnd_Verify_Res_DeisterTag_SingleProd_Annonymous_BookingPass")
	public void ssp_TC_0002_CP_EndToEnd_Verify_Res_DeisterTag_SingleProd_Annonymous_BookingPass(Hashtable<String, String> data)throws Throwable {
