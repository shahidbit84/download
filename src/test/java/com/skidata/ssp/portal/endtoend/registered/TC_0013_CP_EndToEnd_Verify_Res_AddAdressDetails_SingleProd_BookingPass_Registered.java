...
public class TC_0013_CP_EndToEnd_Verify_Res_AddAdressDetails_SingleProd_BookingPass_Registered extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0013_CP_EndToEnd_Verify_Res_AddAdressDetails_SingleProd_BookingPass_Registered.class.getName());

	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0013_CP_EndToEnd_Verify_Res_AddAdressDetails_SingleProd_BookingPass_Registered";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=431,dataProvider = "getDataForTestCaseName", testName = "TC_0013_CP_EndToEnd_Verify_Res_AddAdressDetails_SingleProd_BookingPass_Registered", description ="TC_0013_CP_EndToEnd_Verify_Res_AddAdressDetails_SingleProd_BookingPass_Registered")
	public void ssp_TC_0013_CP_EndToEnd_Verify_Res_AddAdressDetails_SingleProd_BookingPass_Registered(Hashtable<String, String> data)throws Throwable {
