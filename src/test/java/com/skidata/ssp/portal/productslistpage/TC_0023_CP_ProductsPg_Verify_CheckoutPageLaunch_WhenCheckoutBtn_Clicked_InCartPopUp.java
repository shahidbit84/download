...
public class TC_0023_CP_ProductsPg_Verify_CheckoutPageLaunch_WhenCheckoutBtn_Clicked_InCartPopUp extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0023_CP_ProductsPg_Verify_CheckoutPageLaunch_WhenCheckoutBtn_Clicked_InCartPopUp.class.getName());

	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0023_CP_ProductsPg_Verify_CheckoutPageLaunch_WhenCheckoutBtn_Clicked_InCartPopUp";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=223,dataProvider = "getDataForTestCaseName", testName = "TC_0023_CP_ProductsPg_Verify_CheckoutPageLaunch_WhenCheckoutBtn_Clicked_InCartPopUp", description ="TC_0023_CP_ProductsPg_Verify_CheckoutPageLaunch_WhenCheckoutBtn_Clicked_InCartPopUp")
	public void ssp_TC_0023_CP_ProductsPg_Verify_CheckoutPageLaunch_WhenCheckoutBtn_Clicked_InCartPopUp(Hashtable<String, String> data)throws Throwable {
		...
		try {
			...
			sspProductsListPage.clickOnCheckout_InCartPopUpWindow();
