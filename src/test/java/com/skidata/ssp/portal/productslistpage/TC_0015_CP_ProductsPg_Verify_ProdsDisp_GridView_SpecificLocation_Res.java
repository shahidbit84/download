...
public class TC_0015_CP_ProductsPg_Verify_ProdsDisp_GridView_SpecificLocation_Res extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0015_CP_ProductsPg_Verify_ProdsDisp_GridView_SpecificLocation_Res.class.getName());

	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0015_CP_ProductsPg_Verify_ProdsDisp_GridView_SpecificLocation_Res";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=215,dataProvider = "getDataForTestCaseName", testName = "TC_0015_CP_ProductsPg_Verify_ProdsDisp_GridView_SpecificLocation_Res", description ="TC_0015_CP_ProductsPg_Verify_ProdsDisp_GridView_SpecificLocation_Res")
	public void ssp_TC_0015_CP_ProductsPg_Verify_ProdsDisp_GridView_SpecificLocation_Rese(Hashtable<String, String> data)throws Throwable {
