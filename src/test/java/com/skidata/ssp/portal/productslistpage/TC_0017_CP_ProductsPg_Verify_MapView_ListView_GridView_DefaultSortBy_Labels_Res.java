...
public class TC_0017_CP_ProductsPg_Verify_MapView_ListView_GridView_DefaultSortBy_Labels_Res extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0017_CP_ProductsPg_Verify_MapView_ListView_GridView_DefaultSortBy_Labels_Res.class.getName());

	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0017_CP_ProductsPg_Verify_MapView_ListView_GridView_DefaultSortBy_Labels_Res";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=217,dataProvider = "getDataForTestCaseName", testName = "TC_0017_CP_ProductsPg_Verify_MapView_ListView_GridView_DefaultSortBy_Labels_Res", description ="TC_0017_CP_ProductsPg_Verify_MapView_ListView_GridView_DefaultSortBy_Labels_Res")
	public void ssp_TC_0017_CP_ProductsPg_Verify_MapView_ListView_GridView_DefaultSortBy_Labels_Res(Hashtable<String, String> data)throws Throwable {
