...
public class TC_0020_CP_ProductsPg_Verify_AddProds_GridView_Verify_Count_InCartToolTip_Res extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0020_CP_ProductsPg_Verify_AddProds_GridView_Verify_Count_InCartToolTip_Res.class.getName());

	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0020_CP_ProductsPg_Verify_AddProds_GridView_Verify_Count_InCartToolTip_Res";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=220,dataProvider = "getDataForTestCaseName", testName = "TC_0020_CP_ProductsPg_Verify_AddProds_GridView_Verify_Count_InCartToolTip_Res", description ="TC_0020_CP_ProductsPg_Verify_AddProds_GridView_Verify_Count_InCartToolTip_Res")
	public void ssp_TC_0020_CP_ProductsPg_Verify_AddProds_GridView_Verify_Count_InCartToolTip_Res(Hashtable<String, String> data)throws Throwable {
		...
		try {
			...
			int noOfProductsAddedIntoCart = sspProductsListPage.addProducts_IntoCart_Reservation_GridView();
