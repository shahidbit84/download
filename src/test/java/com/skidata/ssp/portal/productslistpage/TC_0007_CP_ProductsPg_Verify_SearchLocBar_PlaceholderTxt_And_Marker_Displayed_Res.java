...
public class TC_0007_CP_ProductsPg_Verify_SearchLocBar_PlaceholderTxt_And_Marker_Displayed_Res extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0007_CP_ProductsPg_Verify_SearchLocBar_PlaceholderTxt_And_Marker_Displayed_Res.class.getName());

	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0007_CP_ProductsPg_Verify_SearchLocBar_PlaceholderTxt_And_Marker_Displayed_Res";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=207,dataProvider = "getDataForTestCaseName", testName = "TC_0007_CP_ProductsPg_Verify_SearchLocBar_PlaceholderTxt_And_Marker_Displayed_Res", description ="TC_0007_CP_ProductsPg_Verify_SearchLocBar_PlaceholderTxt_And_Marker_Displayed_Res")
	public void ssp_TC_0007_CP_ProductsPg_Verify_SearchLocBar_PlaceholderTxt_And_Marker_Displayed_Res(Hashtable<String, String> data)throws Throwable {
