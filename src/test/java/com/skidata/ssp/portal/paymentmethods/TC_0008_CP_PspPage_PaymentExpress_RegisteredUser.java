...
public class TC_0008_CP_PspPage_PaymentExpress_RegisteredUser extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0008_CP_PspPage_PaymentExpress_RegisteredUser.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0008_CP_PspPage_PaymentExpress_RegisteredUser";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=1308,dataProvider = "getDataForTestCaseName", testName = "TC_0008_CP_PspPage_PaymentExpress_RegisteredUser", description ="TC_0008_CP_PspPage_PaymentExpress_RegisteredUser")
	public void ssp_TC_0008_CP_PspPage_PaymentExpress_RegisteredUser(Hashtable<String, String> data)throws Throwable {
		...
		try {
			...
			// Payment express payment method 
			SspPspPages.EnterCreditcardMaestroSecureCodeUserDetailsPaymentExpress(data.get("CardHolderName"),data.get("CardHolderNumber"),
