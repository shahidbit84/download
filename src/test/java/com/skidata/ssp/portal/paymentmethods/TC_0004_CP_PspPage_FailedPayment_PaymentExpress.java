...
public class TC_0004_CP_PspPage_FailedPayment_PaymentExpress extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0004_CP_PspPage_FailedPayment_PaymentExpress.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0004_CP_PspPage_FailedPayment_PaymentExpress";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=1304,dataProvider = "getDataForTestCaseName", testName = "TC_0004_CP_PspPage_FailedPayment_PaymentExpress", description ="TC_0004_CP_PspPage_FailedPayment_PaymentExpress")
	public void ssp_TC_0004_CP_PspPage_FailedPayment_PaymentExpress(Hashtable<String, String> data)throws Throwable {
		...
		try {
			...
			//click cancel to payment fail via payment express 
			SspPspPages.clickCancelPayementExpressPayment();
