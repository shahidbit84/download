...
public class TC_0003_CP_PspPage_PaymentExpressPaymentMethod extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0003_CP_PspPage_PaymentExpressPaymentMethod.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0003_CP_PspPage_PaymentExpressPaymentMethod";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=1303,dataProvider = "getDataForTestCaseName", testName = "TC_0003_CP_PspPage_PaymentExpressPaymentMethod", description ="TC_0003_CP_PspPage_PaymentExpressPaymentMethod")
	public void ssp_TC_0003_CP_PspPage_PaymentExpressPaymentMethod(Hashtable<String, String> data)throws Throwable {
