...
public class TC_0010_CP_PaymentMethodPg_Verify_PageTitle extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0010_CP_PaymentMethodPg_Verify_PageTitle.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0010_CP_PaymentMethodPg_Verify_PageTitle";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=1310,dataProvider = "getDataForTestCaseName", testName = "TC_0010_CP_PaymentMethodPg_Verify_PageTitle", description ="TC_0010_CP_PaymentMethodPg_Verify_PageTitle")
	public void ssp_TC_0010_CP_PaymentMethodPg_Verify_PageTitle(Hashtable<String, String> data)throws Throwable {
