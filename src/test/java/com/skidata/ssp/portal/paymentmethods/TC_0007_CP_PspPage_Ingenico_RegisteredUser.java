...
public class TC_0007_CP_PspPage_Ingenico_RegisteredUser extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0007_CP_PspPage_Ingenico_RegisteredUser.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0007_CP_PspPage_Ingenico_RegisteredUser";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=1307,dataProvider = "getDataForTestCaseName", testName = "TC_0007_CP_PspPage_Ingenico_RegisteredUser", description ="TC_0007_CP_PspPage_Ingenico_RegisteredUser")
	public void ssp_TC_0007_CP_PspPage_Ingenico_RegisteredUser(Hashtable<String, String> data)throws Throwable {
		...
		try {
			...
			// Ingenico payment method 
			SspPspPages.EnterCreditcardMaestroSecureCodeUserDetailsIngenico(data.get("CardHolderName"),data.get("CardHolderNumber"),
