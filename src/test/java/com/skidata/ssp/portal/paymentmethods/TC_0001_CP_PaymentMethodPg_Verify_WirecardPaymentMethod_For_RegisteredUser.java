...
public class TC_0001_CP_PaymentMethodPg_Verify_WirecardPaymentMethod_For_RegisteredUser extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0001_CP_PaymentMethodPg_Verify_WirecardPaymentMethod_For_RegisteredUser.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0001_CP_PaymentMethodPg_Verify_WirecardPaymentMethod_For_RegisteredUser";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=1301,dataProvider = "getDataForTestCaseName", testName = "TC_0001_CP_PaymentMethodPg_Verify_WirecardPaymentMethod_For_RegisteredUser", description ="TC_0001_CP_PaymentMethodPg_Verify_WirecardPaymentMethod_For_RegisteredUser")
	public void ssp_TC_0001_CP_PaymentMethodPg_Verify_WirecardPaymentMethod_For_RegisteredUser(Hashtable<String, String> data)throws Throwable {
