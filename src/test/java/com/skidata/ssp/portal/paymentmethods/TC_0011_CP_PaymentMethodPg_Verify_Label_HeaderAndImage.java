...
public class TC_0011_CP_PaymentMethodPg_Verify_Label_HeaderAndImage extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0011_CP_PaymentMethodPg_Verify_Label_HeaderAndImage.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0011_CP_PaymentMethodPg_Verify_Label_HeaderAndImage";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=1311,dataProvider = "getDataForTestCaseName", testName = "TC_0011_CP_PaymentMethodPg_Verify_Label_HeaderAndImage", description ="TC_0011_CP_PaymentMethodPg_Verify_Label_HeaderAndImage")
	public void ssp_TC_0011_CP_PaymentMethodPg_Verify_Label_HeaderAndImage(Hashtable<String, String> data)throws Throwable {
