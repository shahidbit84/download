...
public class TC_0014_CP_PaymentMethodPg_Verify_WirecardPaymentMethod_For_Anonymous extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0014_CP_PaymentMethodPg_Verify_WirecardPaymentMethod_For_Anonymous.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0014_CP_PaymentMethodPg_Verify_WirecardPaymentMethod_For_Anonymous";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=1314,dataProvider = "getDataForTestCaseName", testName = "TC_0014_CP_PaymentMethodPg_Verify_WirecardPaymentMethod_For_Anonymous", description ="TC_0014_CP_PaymentMethodPg_Verify_WirecardPaymentMethod_For_Anonymous")
	public void ssp_TC_0014_CP_PaymentMethodPg_Verify_WirecardPaymentMethod_For_Anonymous(Hashtable<String, String> data)throws Throwable {
