...
public class TC_0002_CP_PspPage_IngenicoPaymentMethod extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0002_CP_PspPage_IngenicoPaymentMethod.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0002_CP_PspPage_IngenicoPaymentMethod";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=1302,dataProvider = "getDataForTestCaseName", testName = "TC_0002_CP_PspPage_IngenicoPaymentMethod", description ="TC_0002_CP_PspPage_IngenicoPaymentMethod")
	public void ssp_TC_0002_CP_PspPage_IngenicoPaymentMethod(Hashtable<String, String> data)throws Throwable {
