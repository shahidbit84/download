...
public class TC_0003_CP_LoginAndSecurity_Verify_NameUpdate_ProfileUpdateSuccessMsg extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0003_CP_LoginAndSecurity_Verify_NameUpdate_ProfileUpdateSuccessMsg.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0003_CP_LoginAndSecurity_Verify_NameUpdate_ProfileUpdateSuccessMsg";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=903,dataProvider = "getDataForTestCaseName", testName = "TC_0003_CP_LoginAndSecurity_Verify_NameUpdate_ProfileUpdateSuccessMsg", description ="TC_0003_CP_LoginAndSecurity_Verify_NameUpdate_ProfileUpdateSuccessMsg")
	public void ssp_TC_0003_CP_LoginAndSecurity_Verify_NameUpdate_ProfileUpdateSuccessMsg(Hashtable<String, String> data)throws Throwable {
