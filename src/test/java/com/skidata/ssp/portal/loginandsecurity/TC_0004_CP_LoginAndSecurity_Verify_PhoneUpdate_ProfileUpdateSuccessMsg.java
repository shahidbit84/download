...
public class TC_0004_CP_LoginAndSecurity_Verify_PhoneUpdate_ProfileUpdateSuccessMsg extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0004_CP_LoginAndSecurity_Verify_PhoneUpdate_ProfileUpdateSuccessMsg.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0004_CP_LoginAndSecurity_Verify_PhoneUpdate_ProfileUpdateSuccessMsg";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=904,dataProvider = "getDataForTestCaseName", testName = "TC_0004_CP_LoginAndSecurity_Verify_PhoneUpdate_ProfileUpdateSuccessMsg", description ="TC_0004_CP_LoginAndSecurity_Verify_PhoneUpdate_ProfileUpdateSuccessMsg")
	public void ssp_TC_0004_CP_LoginAndSecurity_Verify_PhoneUpdate_ProfileUpdateSuccessMsg(Hashtable<String, String> data)throws Throwable {
