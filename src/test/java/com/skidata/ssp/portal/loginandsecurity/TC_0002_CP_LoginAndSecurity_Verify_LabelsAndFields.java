...
public class TC_0002_CP_LoginAndSecurity_Verify_LabelsAndFields extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0002_CP_LoginAndSecurity_Verify_LabelsAndFields.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0002_CP_LoginAndSecurity_Verify_LabelsAndFields";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=902,dataProvider = "getDataForTestCaseName", testName = "TC_0002_CP_LoginAndSecurity_Verify_LabelsAndFields", description ="TC_0002_CP_LoginAndSecurity_Verify_LabelsAndFields")
	public void ssp_TC_0002_CP_LoginAndSecurity_Verify_LabelsAndFields(Hashtable<String, String> data)throws Throwable {
