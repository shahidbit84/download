...
public class TC_0027_CP_HomePg_SelectAddress_SelectStartEndDate_ClickSearchYourParking_Res extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0027_CP_HomePg_SelectAddress_SelectStartEndDate_ClickSearchYourParking_Res.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0027_CP_HomePg_SelectAddress_SelectStartEndDate_ClickSearchYourParking_Res";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=27,dataProvider = "getDataForTestCaseName", testName = "TC_0027_CP_HomePg_SelectAddress_SelectStartEndDate_ClickSearchYourParking_Res", description ="TC_0027_CP_HomePg_SelectAddress_SelectStartEndDate_ClickSearchYourParking_Res")
	public void ssp_TC_0027_CP_HomePg_SelectAddress_SelectStartEndDate_ClickSearchYourParking_Res(Hashtable<String, String> data)throws Throwable {
