...
public class TC_0025_CP_HomePg_Select_Address_StartEndDate_ClickSearchYourParking_VerifyProdListPageTitle_Res extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0025_CP_HomePg_Select_Address_StartEndDate_ClickSearchYourParking_VerifyProdListPageTitle_Res.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0025_CP_HomePg_Select_Address_StartEndDate_ClickSearchYourParking_VerifyProdListPageTitle_Res";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=25,dataProvider = "getDataForTestCaseName", testName = "TC_0025_CP_HomePg_Select_Address_StartEndDate_ClickSearchYourParking_VerifyProdListPageTitle_Res", description ="TC_0025_CP_HomePg_Select_Address_StartEndDate_ClickSearchYourParking_VerifyProdListPageTitle_Res")
	public void ssp_TC_0025_CP_HomePg_Select_Address_StartEndDate_ClickSearchYourParking_VerifyProdListPageTitle_Res(Hashtable<String, String> data)throws Throwable {
