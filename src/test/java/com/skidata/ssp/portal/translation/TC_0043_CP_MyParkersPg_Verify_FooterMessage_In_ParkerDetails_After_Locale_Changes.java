...
public class TC_0043_CP_MyParkersPg_Verify_FooterMessage_In_ParkerDetails_After_Locale_Changes extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0043_CP_MyParkersPg_Verify_FooterMessage_In_ParkerDetails_After_Locale_Changes.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0043_CP_MyParkersPg_Verify_FooterMessage_In_ParkerDetails_After_Locale_Changes";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=1204,dataProvider = "getDataForTestCaseName", testName = "TC_0043_CP_MyParkersPg_Verify_FooterMessage_In_ParkerDetails_After_Locale_Changes", description ="TC_0043_CP_MyParkersPg_Verify_FooterMessage_In_ParkerDetails_After_Locale_Changes")
	public void ssp_TC_0043_CP_MyParkersPg_Verify_FooterMessage_In_ParkerDetails_After_Locale_Changes(Hashtable<String, String> data)throws Throwable {
		...
		try {
		    ...
		    Assert.assertEquals(status,data.get("ExpectedValuePASS"),"Mismatch in parker Footer Text");
