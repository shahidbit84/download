...
public class TC_0060_CP_SubscriptionPg_SingleProd_Verify_LabelAndHeader_After_BookingPass_And_Locale_Changes extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0060_CP_SubscriptionPg_SingleProd_Verify_LabelAndHeader_After_BookingPass_And_Locale_Changes.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0060_CP_SubscriptionPg_SingleProd_Verify_LabelAndHeader_After_BookingPass_And_Locale_Changes";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=511,dataProvider = "getDataForTestCaseName", testName = "TC_0060_CP_SubscriptionPg_SingleProd_Verify_LabelAndHeader_After_BookingPass_And_Locale_Changes", description ="TC_0060_CP_SubscriptionPg_SingleProd_Verify_LabelAndHeader_After_BookingPass_And_Locale_Changes")
	public void ssp_TC_0060_CP_SubscriptionPg_SingleProd_Verify_LabelAndHeader_After_BookingPass_And_Locale_Changes(Hashtable<String, String> data)throws Throwable {
...
//				}
			...
			sspReservations.verify_Subscriptions_PageHeaderAndLabel_AfterBookingPass(data.get("PageHeader_Subscription"), data.get("PageHeaderShow"), data.get("PageHeaderAllSubscriptions"),data.get("FindSubscription"), data.get("UpcomingSubscription"),data.get("From"), data.get("Duration"), data.get("SubscritionCode"),data.get("TotalPrice"),data.get("View"));
			Assert.assertEquals(status,data.get("ExpectedValuePASS"),"Mismatch in Headers and Labels in Profile Reservation page");
