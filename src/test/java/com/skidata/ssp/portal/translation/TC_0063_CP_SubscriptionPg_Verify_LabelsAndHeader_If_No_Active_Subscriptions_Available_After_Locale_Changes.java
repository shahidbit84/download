...
public class TC_0063_CP_SubscriptionPg_Verify_LabelsAndHeader_If_No_Active_Subscriptions_Available_After_Locale_Changes extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0063_CP_SubscriptionPg_Verify_LabelsAndHeader_If_No_Active_Subscriptions_Available_After_Locale_Changes.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0063_CP_SubscriptionPg_Verify_LabelsAndHeader_If_No_Active_Subscriptions_Available_After_Locale_Changes";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=604,dataProvider = "getDataForTestCaseName", testName = "TC_0063_CP_SubscriptionPg_Verify_LabelsAndHeader_If_No_Active_Subscriptions_Available_After_Locale_Changes", description ="TC_0063_CP_SubscriptionPg_Verify_LabelsAndHeader_If_No_Active_Subscriptions_Available_After_Locale_Changes")
	public void ssp_TC_0063_CP_SubscriptionPg_Verify_LabelsAndHeader_If_No_Active_Subscriptions_Available_After_Locale_Changes(Hashtable<String, String> data)throws Throwable {
