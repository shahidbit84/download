...
public class TC_0054_CP_ConfirmationPg_SingleProd_Verify_ThankYouMsg_Res_Success_Annonymous_Locale_Changes extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0054_CP_ConfirmationPg_SingleProd_Verify_ThankYouMsg_Res_Success_Annonymous_Locale_Changes.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0054_CP_ConfirmationPg_SingleProd_Verify_ThankYouMsg_Res_Success_Annonymous_Locale_Changes";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=603,dataProvider = "getDataForTestCaseName", testName = "TC_0054_CP_ConfirmationPg_SingleProd_Verify_ThankYouMsg_Res_Success_Annonymous_Locale_Changes", description ="TC_0054_CP_ConfirmationPg_SingleProd_Verify_ThankYouMsg_Res_Success_Annonymous_Locale_Changes")
	public void ssp_TC_0054_CP_ConfirmationPg_SingleProd_Verify_ThankYouMsg_Res_Success_Annonymous_Locale_Changes(Hashtable<String, String> data)throws Throwable {
