...
public class TC_0049_CP_ShoppingCartPg_Verify_DeleteConfirmationMsg_Cancel_AndDeleteProd_Locale_Changes extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0049_CP_ShoppingCartPg_Verify_DeleteConfirmationMsg_Cancel_AndDeleteProd_Locale_Changes.class.getName());

	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0049_CP_ShoppingCartPg_Verify_DeleteConfirmationMsg_Cancel_AndDeleteProd_Locale_Changes";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=309,dataProvider = "getDataForTestCaseName", testName = "TC_0049_CP_ShoppingCartPg_Verify_DeleteConfirmationMsg_Cancel_AndDeleteProd_Locale_Changes", description ="TC_0049_CP_ShoppingCartPg_Verify_DeleteConfirmationMsg_Cancel_AndDeleteProd_Locale_Changes")
	public void ssp_TC_0049_CP_ShoppingCartPg_Verify_DeleteConfirmationMsg_Cancel_AndDeleteProd_Locale_Changes(Hashtable<String, String> data)throws Throwable {
		...
		try {
			...
			status=sspShoppingCartPage.verifyDeleteConfirmationMessage_Cancel_AndDeleteProduct(data.get("part1"),data.get("part2"));
