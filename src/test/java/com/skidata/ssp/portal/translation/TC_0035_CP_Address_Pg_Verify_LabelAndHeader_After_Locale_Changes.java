...
public class TC_0035_CP_Address_Pg_Verify_LabelAndHeader_After_Locale_Changes extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0035_CP_Address_Pg_Verify_LabelAndHeader_After_Locale_Changes.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0035_CP_Address_Pg_Verify_LabelAndHeader_After_Locale_Changes";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=702,dataProvider = "getDataForTestCaseName", testName = "TC_0035_CP_Address_Pg_Verify_LabelAndHeader_After_Locale_Changes", description ="TC_0035_CP_Address_Pg_Verify_LabelAndHeader_After_Locale_Changes")
	public void ssp_TC_0035_CP_Address_Pg_Verify_LabelAndHeader_After_Locale_Changes(Hashtable<String, String> data)throws Throwable {
