...
public class TC_0056_CP_ReservationPg_SingleProd_Verify_LabelAndHeader_After_BookingPass_Locale_Changes extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0056_CP_ReservationPg_SingleProd_Verify_LabelAndHeader_After_BookingPass_Locale_Changes.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0056_CP_ReservationPg_SingleProd_Verify_LabelAndHeader_After_BookingPass_Locale_Changes";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=511,dataProvider = "getDataForTestCaseName", testName = "TC_0056_CP_ReservationPg_SingleProd_Verify_LabelAndHeader_After_BookingPass_Locale_Changes", description ="TC_0056_CP_ReservationPg_SingleProd_Verify_LabelAndHeader_After_BookingPass_Locale_Changes")
	public void ssp_TC_0056_CP_ReservationPg_SingleProd_Verify_LabelAndHeader_After_BookingPass_Locale_Changes(Hashtable<String, String> data)throws Throwable {
...
//				}
			...
			status=sspReservations.verifyPageHeaderAndLabel_AfterBookingPass(data.get("PageHeaderReservation"),data.get("PageHeaderShow"),data.get("PageHeaderAllReservation"));
			Assert.assertEquals(status,data.get("ExpectedValuePASS"),"Mismatch in Reservation Page Label And Header After Booking Pass");
			
			status=sspReservations.verifySingleProduct_HeaderAndLabel_AfterBookingPass(data.get("PageHeaderUpcomingReservation"),data.get("PageHeaderCancelSelectedReservation"),data.get("From"),data.get("To"),data.get("ReservationCode"),data.get("TotalPrice"),data.get("View"));
			Assert.assertEquals(status,data.get("ExpectedValuePASS"),"Mismatch in Reservation Product Label And Header After Booking Pass");
