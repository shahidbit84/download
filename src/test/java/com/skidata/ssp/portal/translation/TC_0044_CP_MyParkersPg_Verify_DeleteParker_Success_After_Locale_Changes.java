...
public class TC_0044_CP_MyParkersPg_Verify_DeleteParker_Success_After_Locale_Changes extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0044_CP_MyParkersPg_Verify_DeleteParker_Success_After_Locale_Changes.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0044_CP_MyParkersPg_Verify_DeleteParker_Success_After_Locale_Changes";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=1209,dataProvider = "getDataForTestCaseName", testName = "TC_0044_CP_MyParkersPg_Verify_DeleteParker_Success_After_Locale_Changes", description ="TC_0044_CP_MyParkersPg_Verify_DeleteParker_Success_After_Locale_Changes")
	public void ssp_TC_0044_CP_MyParkersPg_Verify_DeleteParker_Success_After_Locale_Changes(Hashtable<String, String> data)throws Throwable {
		...
		try {
		    ...
		    myParkersPage.clickOnDeleteParkerIcon_();
		    
		    status=myParkersPage.verifyDeleteConfirmationMessage(data.get("DeleteConfirmation"));
		    ...
		    myParkersPage.clickOnNoDeleteConfirmationPopUp();
		    ...
		    myParkersPage.clickOnYesDeleteConfirmationPopUp();
		    
		    myParkersPage.verifyParkerDeleted();
		    Assert.assertEquals(status,data.get("ExpectedValuePASS"),"Parker is not deleted successfully");
