...
public class TC_0059_CP_ReservationPg_SingleProd_Verify_EmailConfirmationMessage_When_ClickedOnResendConfirmationEmail_After_Locale_Changes extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0059_CP_ReservationPg_SingleProd_Verify_EmailConfirmationMessage_When_ClickedOnResendConfirmationEmail_After_Locale_Changes.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0059_CP_ReservationPg_SingleProd_Verify_EmailConfirmationMessage_When_ClickedOnResendConfirmationEmail_After_Locale_Changes";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=512,dataProvider = "getDataForTestCaseName", testName = "TC_0059_CP_ReservationPg_SingleProd_Verify_EmailConfirmationMessage_When_ClickedOnResendConfirmationEmail_After_Locale_Changes", description ="TC_0059_CP_ReservationPg_SingleProd_Verify_EmailConfirmationMessage_When_ClickedOnResendConfirmationEmail_After_Locale_Changes")
	public void ssp_TC_0059_CP_ReservationPg_SingleProd_Verify_EmailConfirmationMessage_When_ClickedOnResendConfirmationEmail_After_Locale_Changes(Hashtable<String, String> data)throws Throwable {
...
//        	
//            sspCheckoutPage.EnterIamNotTheParkerDetails(data.get("ParkerName"),data.get("ParkerEmail") );
...
//				}
			...
			log(driver.getTitle());
			sspReservations.verifyPageTitle(data.get("PageTitle_ViewReservations_Page"));
			Assert.assertEquals(status,data.get("ExpectedValuePASS"),"User not navigated to Reservations page");
            
			Thread.sleep(5000);
			
			sspReservations.ClickOn_ResendConfirmationMailLink();
			
			status=sspReservations.verifyEmail_ConfirmationMessage(data.get("confirmation_email_sent"));
			Assert.assertEquals(status,data.get("ExpectedValuePASS"),"Mismatch In Resend Email Confirmation Message");
