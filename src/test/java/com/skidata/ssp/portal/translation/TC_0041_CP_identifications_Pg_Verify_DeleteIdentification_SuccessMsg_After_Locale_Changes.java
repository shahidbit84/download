...
public class TC_0041_CP_identifications_Pg_Verify_DeleteIdentification_SuccessMsg_After_Locale_Changes extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0041_CP_identifications_Pg_Verify_DeleteIdentification_SuccessMsg_After_Locale_Changes.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0041_CP_identifications_Pg_Verify_DeleteIdentification_SuccessMsg_After_Locale_Changes";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=817,dataProvider = "getDataForTestCaseName", testName = "TC_0041_CP_identifications_Pg_Verify_DeleteIdentification_SuccessMsg_After_Locale_Changes", description ="TC_0041_CP_identifications_Pg_Verify_DeleteIdentification_SuccessMsg_After_Locale_Changes")
	public void ssp_TC_0041_CP_identifications_Pg_Verify_DeleteIdentification_SuccessMsg_After_Locale_Changes(Hashtable<String, String> data)throws Throwable {
...
//		    Assert.assertEquals(status,data.get("ExpectedValuePASS"),"Mismatch in the Id details displayed after adding");
		    ...
		    status=identificationsPage._verifyAddedVerificationDetails(data.get("Identificationtype3"),data.get("IdentificationValue3"));
		    Assert.assertEquals(status,data.get("ExpectedValuePASS"),"Mismatch in the Id details displayed after adding");
