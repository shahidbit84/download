...
public class TC_0045_CP_MyParkersPg_Verify_Error_Message_For_Invalid_Email_After_Locale_Changes extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0045_CP_MyParkersPg_Verify_Error_Message_For_Invalid_Email_After_Locale_Changes.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0045_CP_MyParkersPg_Verify_Error_Message_For_Invalid_Email_After_Locale_Changes";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=1210,dataProvider = "getDataForTestCaseName", testName = "TC_0045_CP_MyParkersPg_Verify_Error_Message_For_Invalid_Email_After_Locale_Changes", description ="TC_0045_CP_MyParkersPg_Verify_Error_Message_For_Invalid_Email_After_Locale_Changes")
	public void ssp_TC_0045_CP_MyParkersPg_Verify_Error_Message_For_Invalid_Email_After_Locale_Changes(Hashtable<String, String> data)throws Throwable {
