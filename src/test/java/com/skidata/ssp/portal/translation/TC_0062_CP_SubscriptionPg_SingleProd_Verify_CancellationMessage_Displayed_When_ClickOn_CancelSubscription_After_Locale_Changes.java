...
public class TC_0062_CP_SubscriptionPg_SingleProd_Verify_CancellationMessage_Displayed_When_ClickOn_CancelSubscription_After_Locale_Changes extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0062_CP_SubscriptionPg_SingleProd_Verify_CancellationMessage_Displayed_When_ClickOn_CancelSubscription_After_Locale_Changes.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0062_CP_SubscriptionPg_SingleProd_Verify_CancellationMessage_Displayed_When_ClickOn_CancelSubscription_After_Locale_Changes";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=512,dataProvider = "getDataForTestCaseName", testName = "TC_0062_CP_SubscriptionPg_SingleProd_Verify_CancellationMessage_Displayed_When_ClickOn_CancelSubscription_After_Locale_Changes", description ="TC_0062_CP_SubscriptionPg_SingleProd_Verify_CancellationMessage_Displayed_When_ClickOn_CancelSubscription_After_Locale_Changes")
	public void ssp_TC_0062_CP_SubscriptionPg_SingleProd_Verify_CancellationMessage_Displayed_When_ClickOn_CancelSubscription_After_Locale_Changes(Hashtable<String, String> data)throws Throwable {
...
//				}
            ...
            sspReservations.ClickOn_CancelSubscription();
              
            status=sspReservations.verifyCancelSubscriptionMessage(data.get("CancelSubscriptionMessage"));
            Assert.assertEquals(status,data.get("ExpectedValuePASS"),"Mismatch In The Cancel Subscription Message");
