...
public class TC_0028_CP_LoginAndSecurity_Pg_Verify_LabelsAndFields_After_Locale_Changes extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0028_CP_LoginAndSecurity_Pg_Verify_LabelsAndFields_After_Locale_Changes.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0028_CP_LoginAndSecurity_Pg_Verify_LabelsAndFields_After_Locale_Changes";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=902,dataProvider = "getDataForTestCaseName", testName = "TC_0028_CP_LoginAndSecurity_Pg_Verify_LabelsAndFields_After_Locale_Changes", description ="TC_0028_CP_LoginAndSecurity_Pg_Verify_LabelsAndFields_After_Locale_Changes")
	public void ssp_TC_0028_CP_LoginAndSecurity_Pg_Verify_LabelsAndFields_After_Locale_Changes(Hashtable<String, String> data)throws Throwable {
		...
		try {
		    ...
		    status=loginAndSecurityPage.verifyHeader(data.get("pageHeaderLoginAndSecurity"));
		    Assert.assertEquals(status,data.get("ExpectedValuePASS"),"Mismatch in the Page header loginAndSecurity");
