...
public class TC_0012_CP_LoginPg_Verify_NavigateToResetPasswordPg_WhenClickedOnForgotPassword extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0012_CP_LoginPg_Verify_NavigateToResetPasswordPg_WhenClickedOnForgotPassword.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0012_CP_LoginPg_Verify_NavigateToResetPasswordPg_WhenClickedOnForgotPassword";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=1100,dataProvider = "getDataForTestCaseName", testName = "TC_0012_CP_LoginPg_Verify_NavigateToResetPasswordPg_WhenClickedOnForgotPassword", description ="TC_0012_CP_LoginPg_Verify_NavigateToResetPasswordPg_WhenClickedOnForgotPassword")
	public void ssp_TC_0012_CP_LoginPg_Verify_NavigateToResetPasswordPg_WhenClickedOnForgotPassword(Hashtable<String, String> data)throws Throwable {
