...
public class TC_0012_CP_AddressPage_Verify_Discard_Confirmation_Message_Popup_For_Company extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0012_CP_AddressPage_Verify_Discard_Confirmation_Message_Popup_For_Company.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0012_CP_AddressPage_Verify_Discard_Confirmation_Message_Popup_For_Company";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=712,dataProvider = "getDataForTestCaseName", testName = "TC_0012_CP_AddressPage_Verify_Discard_Confirmation_Message_Popup_For_Company", description ="TC_0012_CP_AddressPage_Verify_Discard_Confirmation_Message_Popup_For_Company")
	public void ssp_TC_0012_CP_AddressPage_Verify_Discard_Confirmation_Message_Popup_For_Company(Hashtable<String, String> data)throws Throwable {
		...
		try {
		    ...
		    addressesPage.Company_Name(data.get("CompanyName"));
		    Assert.assertEquals(status,data.get("ExpectedValuePASS"),"Mismatch in the Company name");
