...
public class TC_0001_CP_identifications_Verify_PageTitle extends TestBase {
	...
	public static final Logger log = Logger.getLogger(TC_0001_CP_identifications_Verify_PageTitle.class.getName());
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=801,dataProvider = "getDataForTestCaseName", testName = "TC_0001_CP_identifications_Verify_PageTitle", description ="TC_0001_CP_identifications_Verify_PageTitle")
	public void ssp_TC_0001_CP_identifications_Verify_PageTitle(Hashtable<String, String> data)throws Throwable {
