...
public class TC_0009_CP_identifications_Verify_EditIdentification_Success_DeisterTag extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0009_CP_identifications_Verify_EditIdentification_Success_DeisterTag.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0009_CP_identifications_Verify_EditIdentification_Success_DeisterTag";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=810,dataProvider = "getDataForTestCaseName", testName = "TC_0009_CP_identifications_Verify_EditIdentification_Success_DeisterTag", description ="TC_0009_CP_identifications_Verify_EditIdentification_Success_DeisterTag")
	public void ssp_TC_0009_CP_identifications_Verify_EditIdentification_Success_DeisterTag(Hashtable<String, String> data)throws Throwable {
...
//		    Assert.assertEquals(status,data.get("ExpectedValuePASS"),"Mismatch in the Id details displayed after adding");
		    ...
		    status=identificationsPage._verifyAddedVerificationDetails(data.get("Identificationtype2"),data.get("IdentificationValue2"));
		    Assert.assertEquals(status,data.get("ExpectedValuePASS"),"Mismatch in the Id details displayed after adding");
		    ...
		    status=identificationsPage._verifyAddedVerificationDetails(data.get("Identificationtype2"),data.get("_EditIdentificationValue"));
		    Assert.assertEquals(status,data.get("ExpectedValuePASS"),"Mismatch in the Id details displayed after adding");
