...
public class TC_0010_CP_identifications_Verify_EditIdentification_Success_Skidata extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0010_CP_identifications_Verify_EditIdentification_Success_Skidata.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0010_CP_identifications_Verify_EditIdentification_Success_Skidata";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=811,dataProvider = "getDataForTestCaseName", testName = "TC_0010_CP_identifications_Verify_EditIdentification_Success_Skidata", description ="TC_0010_CP_identifications_Verify_EditIdentification_Success_Skidata")
	public void ssp_TC_0010_CP_identifications_Verify_EditIdentification_Success_Skidata(Hashtable<String, String> data)throws Throwable {
...
//		    Assert.assertEquals(status,data.get("ExpectedValuePASS"),"Mismatch in the Id details displayed after adding");
		    ...
		    status=identificationsPage._verifyAddedVerificationDetails(data.get("Identificationtype3"),data.get("_EditIdentificationValue"));
		    Assert.assertEquals(status,data.get("ExpectedValuePASS"),"Mismatch in the Id details displayed after adding");
