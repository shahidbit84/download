...
public class TC_0013_CP_identifications_Verify_DeleteIdentification_Success_MifareCard extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0013_CP_identifications_Verify_DeleteIdentification_Success_MifareCard.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0013_CP_identifications_Verify_DeleteIdentification_Success_MifareCard";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=815,dataProvider = "getDataForTestCaseName", testName = "TC_0013_CP_identifications_Verify_DeleteIdentification_Success_MifareCard", description ="TC_0013_CP_identifications_Verify_DeleteIdentification_Success_MifareCard")
	public void ssp_TC_0013_CP_identifications_Verify_DeleteIdentification_Success_MifareCard(Hashtable<String, String> data)throws Throwable {
