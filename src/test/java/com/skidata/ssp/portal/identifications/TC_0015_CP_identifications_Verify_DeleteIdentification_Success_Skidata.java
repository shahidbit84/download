...
public class TC_0015_CP_identifications_Verify_DeleteIdentification_Success_Skidata extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0015_CP_identifications_Verify_DeleteIdentification_Success_Skidata.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0015_CP_identifications_Verify_DeleteIdentification_Success_Skidata";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=817,dataProvider = "getDataForTestCaseName", testName = "TC_0015_CP_identifications_Verify_DeleteIdentification_Success_Skidata", description ="TC_0015_CP_identifications_Verify_DeleteIdentification_Success_Skidata")
	public void ssp_TC_0015_CP_identifications_Verify_DeleteIdentification_Success_Skidata(Hashtable<String, String> data)throws Throwable {
