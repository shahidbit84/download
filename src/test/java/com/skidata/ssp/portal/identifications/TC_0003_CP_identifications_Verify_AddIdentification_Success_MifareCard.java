...
public class TC_0003_CP_identifications_Verify_AddIdentification_Success_MifareCard extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0003_CP_identifications_Verify_AddIdentification_Success_MifareCard.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0003_CP_identifications_Verify_AddIdentification_Success_MifareCard";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=803,dataProvider = "getDataForTestCaseName", testName = "TC_0003_CP_identifications_Verify_AddIdentification_Success_MifareCard", description ="TC_0003_CP_identifications_Verify_AddIdentification_Success_MifareCard")
	public void ssp_TC_0003_CP_identifications_Verify_AddIdentification_Success_MifareCard(Hashtable<String, String> data)throws Throwable {
