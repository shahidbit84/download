...
public class TC_0012_CP_identifications_Verify_EditIdentification_Success_LicensePlate extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0012_CP_identifications_Verify_EditIdentification_Success_LicensePlate.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0012_CP_identifications_Verify_EditIdentification_Success_LicensePlate";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=814,dataProvider = "getDataForTestCaseName", testName = "TC_0012_CP_identifications_Verify_EditIdentification_Success_LicensePlate", description ="TC_0012_CP_identifications_Verify_EditIdentification_Success_LicensePlate")
	public void ssp_TC_0012_CP_identifications_Verify_EditIdentification_Success_LicensePlate(Hashtable<String, String> data)throws Throwable {
...
//		    Assert.assertEquals(status,data.get("ExpectedValuePASS"),"Mismatch in the Page title of Identifications page");
		    ...
		    identificationsPage.addIdentificationDetails_LicencePlate(data.get("Identificationtype"),data.get("IdentificationValue"),data.get("CarType"));
...
//		    Assert.assertEquals(status,data.get("ExpectedValuePASS"),"Mismatch in the Id details displayed after adding");
		    ...
		    status=identificationsPage._verifyAddedVerificationDetails(data.get("Identificationtype6"),data.get("IdentificationValue6"));
		    Assert.assertEquals(status,data.get("ExpectedValuePASS"),"Mismatch in the Id details displayed after adding");
		    ...
		    status=identificationsPage._verifyAddedVerificationDetails(data.get("Identificationtype6"),data.get("_EditIdentificationValue"));
		    Assert.assertEquals(status,data.get("ExpectedValuePASS"),"Mismatch in the Id details displayed after adding");
