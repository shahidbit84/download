...
public class TC_0007_CP_identifications_Verify_AddIdentification_Success_LicensePlate extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0007_CP_identifications_Verify_AddIdentification_Success_LicensePlate.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0007_CP_identifications_Verify_AddIdentification_Success_LicensePlate";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=808,dataProvider = "getDataForTestCaseName", testName = "TC_0007_CP_identifications_Verify_AddIdentification_Success_LicensePlate", description ="TC_0007_CP_identifications_Verify_AddIdentification_Success_LicensePlate")
	public void ssp_TC_0007_CP_identifications_Verify_AddIdentification_Success_LicensePlate(Hashtable<String, String> data)throws Throwable {
