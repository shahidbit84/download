...
public class TC_0017_CP_identifications_Verify_DeleteIdentification_Success_LicensePlate extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0017_CP_identifications_Verify_DeleteIdentification_Success_LicensePlate.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0017_CP_identifications_Verify_DeleteIdentification_Success_LicensePlate";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=820,dataProvider = "getDataForTestCaseName", testName = "TC_0017_CP_identifications_Verify_DeleteIdentification_Success_LicensePlate", description ="TC_0017_CP_identifications_Verify_DeleteIdentification_Success_LicensePlate")
	public void ssp_TC_0017_CP_identifications_Verify_DeleteIdentification_Success_LicensePlate(Hashtable<String, String> data)throws Throwable {
...
//		    Assert.assertEquals(status,data.get("ExpectedValuePASS"),"Mismatch in the Id details displayed after adding");
		    ...
		    status=identificationsPage._verifyAddedVerificationDetails(data.get("Identificationtype5"),data.get("IdentificationValue5"));
		    Assert.assertEquals(status,data.get("ExpectedValuePASS"),"Mismatch in the Id details displayed after adding");
