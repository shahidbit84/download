...
public class TC_0008_CP_identifications_Verify_EditIdentification_Success_MifareCard extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0008_CP_identifications_Verify_EditIdentification_Success_MifareCard.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0008_CP_identifications_Verify_EditIdentification_Success_MifareCard";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=809,dataProvider = "getDataForTestCaseName", testName = "TC_0008_CP_identifications_Verify_EditIdentification_Success_MifareCard", description ="TC_0008_CP_identifications_Verify_EditIdentification_Success_MifareCard")
	public void ssp_TC_0008_CP_identifications_Verify_EditIdentification_Success_MifareCard(Hashtable<String, String> data)throws Throwable {
...
//		    Assert.assertEquals(status,data.get("ExpectedValuePASS"),"Mismatch in the Id details displayed after adding");
		    ...
		    status=identificationsPage._verifyAddedVerificationDetails(data.get("Identificationtype1"),data.get("IdentificationValue1"));
		    Assert.assertEquals(status,data.get("ExpectedValuePASS"),"Mismatch in the Id details displayed after adding");
		    ...
		    status=identificationsPage._verifyAddedVerificationDetails(data.get("Identificationtype1"),data.get("Edit_IdentificationValue"));
		    Assert.assertEquals(status,data.get("ExpectedValuePASS"),"Mismatch in the Id details displayed after adding");
