...
public class TC_0006_CP_identifications_Verify_AddIdentification_Success_SkidataKeycard extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0006_CP_identifications_Verify_AddIdentification_Success_SkidataKeycard.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0006_CP_identifications_Verify_AddIdentification_Success_SkidataKeycard";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=806,dataProvider = "getDataForTestCaseName", testName = "TC_0006_CP_identifications_Verify_AddIdentification_Success_SkidataKeycard", description ="TC_0006_CP_identifications_Verify_AddIdentification_Success_SkidataKeycard")
	public void ssp_TC_0006_CP_identifications_Verify_AddIdentification_Success_SkidataKeycard(Hashtable<String, String> data)throws Throwable {
