...
public class TC_0014_CP_identifications_Verify_DeleteIdentification_Success_DeisterTag extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0014_CP_identifications_Verify_DeleteIdentification_Success_DeisterTag.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0014_CP_identifications_Verify_DeleteIdentification_Success_DeisterTag";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=816,dataProvider = "getDataForTestCaseName", testName = "TC_0014_CP_identifications_Verify_DeleteIdentification_Success_DeisterTag", description ="TC_0014_CP_identifications_Verify_DeleteIdentification_Success_DeisterTag")
	public void ssp_TC_0014_CP_identifications_Verify_DeleteIdentification_Success_DeisterTag(Hashtable<String, String> data)throws Throwable {
