 ...
 *
 */
package com.skidata.ssp.portal.logout;
...
public class TC_0001_CP_Verify_Logout_Success extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0001_CP_Verify_Logout_Success.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0001_CP_Verify_Logout_Success";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=1100,dataProvider = "getDataForTestCaseName", testName = "TC_0001_CP_Verify_Logout_Success", description ="TC_0001_CP_Verify_Logout_Success")
	public void ssp_TC_0001_CP_Verify_Logout_Success(Hashtable<String, String> data)throws Throwable {
