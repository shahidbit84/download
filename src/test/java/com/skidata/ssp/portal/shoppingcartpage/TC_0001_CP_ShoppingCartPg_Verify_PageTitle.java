...
public class TC_0001_CP_ShoppingCartPg_Verify_PageTitle extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0001_CP_ShoppingCartPg_Verify_PageTitle.class.getName());

	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0001_CP_ShoppingCartPg_Verify_PageTitle";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=301,dataProvider = "getDataForTestCaseName", testName = "TC_0001_CP_ShoppingCartPg_Verify_PageTitle", description ="TC_0001_CP_ShoppingCartPg_Verify_PageTitle")
	public void ssp_TC_0001_CP_ShoppingCartPg_Verify_PageTitle(Hashtable<String, String> data)throws Throwable {
		...
		try {
			...
			status=sspShoppingCartPage.verifyPageTitle(data.get("PageTitleCartPage"));
