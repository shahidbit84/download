...
public class TC_0006_CP_ShoppingCartPg_Verify_FromAndTo_Labels_DispForAllAddedProds extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0006_CP_ShoppingCartPg_Verify_FromAndTo_Labels_DispForAllAddedProds.class.getName());

	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0006_CP_ShoppingCartPg_Verify_FromAndTo_Labels_DispForAllAddedProds";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=306,dataProvider = "getDataForTestCaseName", testName = "TC_0006_CP_ShoppingCartPg_Verify_FromAndTo_Labels_DispForAllAddedProds", description ="TC_0006_CP_ShoppingCartPg_Verify_FromAndTo_Labels_DispForAllAddedProds")
	public void ssp_TC_0006_CP_ShoppingCartPg_Verify_FromAndTo_Labels_DispForAllAddedProds(Hashtable<String, String> data)throws Throwable {
		...
		try {
		    ...
		    status=sspShoppingCartPage.verifyFromToLabelForAllProductsInCartPage(data.get("FromLabel"),data.get("ToLabel"));
