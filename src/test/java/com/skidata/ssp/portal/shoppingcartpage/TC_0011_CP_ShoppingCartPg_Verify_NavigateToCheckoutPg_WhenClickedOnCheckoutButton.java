...
public class TC_0011_CP_ShoppingCartPg_Verify_NavigateToCheckoutPg_WhenClickedOnCheckoutButton extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0011_CP_ShoppingCartPg_Verify_NavigateToCheckoutPg_WhenClickedOnCheckoutButton.class.getName());

	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0011_CP_ShoppingCartPg_Verify_NavigateToCheckoutPg_WhenClickedOnCheckoutButton";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=311,dataProvider = "getDataForTestCaseName", testName = "TC_0011_CP_ShoppingCartPg_Verify_NavigateToCheckoutPg_WhenClickedOnCheckoutButton", description ="TC_0011_CP_ShoppingCartPg_Verify_NavigateToCheckoutPg_WhenClickedOnCheckoutButton")
	public void ssp_TC_0011_CP_ShoppingCartPg_Verify_NavigateToCheckoutPg_WhenClickedOnCheckoutButton(Hashtable<String, String> data)throws Throwable {
