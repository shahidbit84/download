...
public class TC_0008_CP_ShoppingCartPg_Verify_AllProducts_Added_And_DeletedSuccessfully extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0008_CP_ShoppingCartPg_Verify_AllProducts_Added_And_DeletedSuccessfully.class.getName());

	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0008_CP_ShoppingCartPg_Verify_AllProducts_Added_And_DeletedSuccessfully";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=308,dataProvider = "getDataForTestCaseName", testName = "TC_0008_CP_ShoppingCartPg_Verify_AllProducts_Added_And_DeletedSuccessfully", description ="TC_0008_CP_ShoppingCartPg_Verify_AllProducts_Added_And_DeletedSuccessfully")
	public void ssp_TC_0008_CP_ShoppingCartPg_Verify_AllProducts_Added_And_DeletedSuccessfully(Hashtable<String, String> data)throws Throwable {
