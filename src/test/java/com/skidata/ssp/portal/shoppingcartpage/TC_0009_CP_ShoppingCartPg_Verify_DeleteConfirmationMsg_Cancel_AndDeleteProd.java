...
public class TC_0009_CP_ShoppingCartPg_Verify_DeleteConfirmationMsg_Cancel_AndDeleteProd extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0009_CP_ShoppingCartPg_Verify_DeleteConfirmationMsg_Cancel_AndDeleteProd.class.getName());

	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0009_CP_ShoppingCartPg_Verify_DeleteConfirmationMsg_Cancel_AndDeleteProd";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=309,dataProvider = "getDataForTestCaseName", testName = "TC_0009_CP_ShoppingCartPg_Verify_DeleteConfirmationMsg_Cancel_AndDeleteProd", description ="TC_0009_CP_ShoppingCartPg_Verify_DeleteConfirmationMsg_Cancel_AndDeleteProd")
	public void ssp_TC_0009_CP_ShoppingCartPg_Verify_DeleteConfirmationMsg_Cancel_AndDeleteProd(Hashtable<String, String> data)throws Throwable {
