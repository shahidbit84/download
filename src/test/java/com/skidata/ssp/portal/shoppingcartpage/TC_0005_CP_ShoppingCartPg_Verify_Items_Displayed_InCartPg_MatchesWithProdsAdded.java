...
public class TC_0005_CP_ShoppingCartPg_Verify_Items_Displayed_InCartPg_MatchesWithProdsAdded extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0005_CP_ShoppingCartPg_Verify_Items_Displayed_InCartPg_MatchesWithProdsAdded.class.getName());

	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0005_CP_ShoppingCartPg_Verify_Items_Displayed_InCartPg_MatchesWithProdsAdded";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=305,dataProvider = "getDataForTestCaseName", testName = "TC_0005_CP_ShoppingCartPg_Verify_Items_Displayed_InCartPg_MatchesWithProdsAdded", description ="TC_0005_CP_ShoppingCartPg_Verify_Items_Displayed_InCartPg_MatchesWithProdsAdded")
	public void ssp_TC_0005_CP_ShoppingCartPg_Verify_Items_Displayed_InCartPg_MatchesWithProdsAdded(Hashtable<String, String> data)throws Throwable {
		...
		try {
		    ...
		    status=sspShoppingCartPage.verifyNoOfProductsDisplayedIsCorrect();
		    Assert.assertEquals(status,data.get("ExpectedValuePASS"),"Mismatch in the No of products in cart icon and Cart page ");
