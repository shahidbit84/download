...
public class TC_0007_CP_ShoppingCartPg_Verify_DeleteIcon_DisplayedForAllAddedProds extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0007_CP_ShoppingCartPg_Verify_DeleteIcon_DisplayedForAllAddedProds.class.getName());

	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0007_CP_ShoppingCartPg_Verify_DeleteIcon_DisplayedForAllAddedProds";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=307,dataProvider = "getDataForTestCaseName", testName = "TC_0007_CP_ShoppingCartPg_Verify_DeleteIcon_DisplayedForAllAddedProds", description ="TC_0007_CP_ShoppingCartPg_Verify_DeleteIcon_DisplayedForAllAddedProds")
	public void ssp_TC_0007_CP_ShoppingCartPg_Verify_DeleteIcon_DisplayedForAllAddedProds(Hashtable<String, String> data)throws Throwable {
		...
		try {
		    ...
		    status=sspShoppingCartPage.verifyDeleteIconForAllProductsInCartPage();
