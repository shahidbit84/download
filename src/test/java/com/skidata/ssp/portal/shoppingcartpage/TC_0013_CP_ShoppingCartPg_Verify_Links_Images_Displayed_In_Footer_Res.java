...
public class TC_0013_CP_ShoppingCartPg_Verify_Links_Images_Displayed_In_Footer_Res extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0013_CP_ShoppingCartPg_Verify_Links_Images_Displayed_In_Footer_Res.class.getName());

	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0013_CP_ShoppingCartPg_Verify_Links_Images_Displayed_In_Footer_Res";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=313,dataProvider = "getDataForTestCaseName", testName = "TC_0013_CP_ShoppingCartPg_Verify_Links_Images_Displayed_In_Footer_Res", description ="TC_0013_CP_ShoppingCartPg_Verify_Links_Images_Displayed_In_Footer_Res")
	public void ssp_TC_0013_CP_ShoppingCartPg_Verify_Links_Images_Displayed_In_Footer_Res(Hashtable<String, String> data)throws Throwable {
		...
		try {
			...
			//Selecting the From and To Date in the Home page
			...
			status=sspShoppingCartPage.verifyHomePageFooterUrls_AreDisplayed(data.get("FAQlabel"),data.get("TermsOfUseLabel"),data.get("OnlineParkingTClabel"),data.get("PrivacyPolicy"),data.get("NeedHelpLabel"),
