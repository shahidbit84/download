...
public class TC_0014_CP_ShoppingCartPg_Verify_AllProducts_Added_And_TotalMatchesWithCartPopUp extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0014_CP_ShoppingCartPg_Verify_AllProducts_Added_And_TotalMatchesWithCartPopUp.class.getName());

	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0014_CP_ShoppingCartPg_Verify_AllProducts_Added_And_TotalMatchesWithCartPopUp";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=314,dataProvider = "getDataForTestCaseName", testName = "TC_0014_CP_ShoppingCartPg_Verify_AllProducts_Added_And_TotalMatchesWithCartPopUp", description ="TC_0014_CP_ShoppingCartPg_Verify_AllProducts_Added_And_TotalMatchesWithCartPopUp")
	public void ssp_TC_0014_CP_ShoppingCartPg_Verify_AllProducts_Added_And_TotalMatchesWithCartPopUp(Hashtable<String, String> data)throws Throwable {
		...
		try {
			...
			String cartPopUpTotalPrice= sspProductsListPage.getCartTotalPrice();

		    sspProductsListPage.clickOnShoppingCartIcon();
				
			SspShoppingCartPage sspShoppingCartPage = new SspShoppingCartPage(driver, test);
			
			String totalPriceFromCartPage=sspShoppingCartPage.getTotalAmountFromCartPage();
		   
			status= sspShoppingCartPage.verifyTotalbetweenCartPopUpAndCartPage(cartPopUpTotalPrice,totalPriceFromCartPage);
			Assert.assertEquals(status,data.get("ExpectedValuePASS"),"Products are not displayed in the List view");
