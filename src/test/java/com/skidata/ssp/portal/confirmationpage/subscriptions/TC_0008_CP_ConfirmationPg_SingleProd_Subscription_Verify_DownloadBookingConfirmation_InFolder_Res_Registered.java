...
public class TC_0008_CP_ConfirmationPg_SingleProd_Subscription_Verify_DownloadBookingConfirmation_InFolder_Res_Registered extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0008_CP_ConfirmationPg_SingleProd_Subscription_Verify_DownloadBookingConfirmation_InFolder_Res_Registered.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0008_CP_ConfirmationPg_SingleProd_Subscription_Verify_DownloadBookingConfirmation_InFolder_Res_Registered";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=608,dataProvider = "getDataForTestCaseName", testName = "TC_0008_CP_ConfirmationPg_SingleProd_Subscription_Verify_DownloadBookingConfirmation_InFolder_Res_Registered", description ="TC_0008_CP_ConfirmationPg_SingleProd_Subscription_Verify_DownloadBookingConfirmation_InFolder_Res_Registered")
	public void ssp_TC_0008_CP_ConfirmationPg_SingleProd_Subscription_Verify_DownloadBookingConfirmation_InFolder_Res_Registered(Hashtable<String, String> data)throws Throwable {
...
//				}
			...
			//FileUtils.cleanDirectory(new File(ConstantValues.DOWNLOAD_PDF_ETICKET_FOLDER));
			
			sspBookingConfirmationPage.clickonDownloadBookingConfirmation();
			
			Thread.sleep(25000);

			String downloadPath = ConstantValues.DOWNLOAD_PDF_ETICKET_FOLDER;
			
			status = sspBookingConfirmationPage.isFileDownloaded_Ext(downloadPath,data.get("FileExtensionOrName"));
			Assert.assertEquals(status,data.get("ExpectedValuePASS"),"eTicket not downloaded successfully");
