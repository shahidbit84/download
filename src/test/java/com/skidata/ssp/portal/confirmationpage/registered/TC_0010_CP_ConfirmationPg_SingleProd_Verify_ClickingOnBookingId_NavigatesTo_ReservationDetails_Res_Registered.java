...
public class TC_0010_CP_ConfirmationPg_SingleProd_Verify_ClickingOnBookingId_NavigatesTo_ReservationDetails_Res_Registered extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0010_CP_ConfirmationPg_SingleProd_Verify_ClickingOnBookingId_NavigatesTo_ReservationDetails_Res_Registered.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0010_CP_ConfirmationPg_SingleProd_Verify_ClickingOnBookingId_NavigatesTo_ReservationDetails_Res_Registered";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=510,dataProvider = "getDataForTestCaseName", testName = "TC_0010_CP_ConfirmationPg_SingleProd_Verify_ClickingOnBookingId_NavigatesTo_ReservationDetails_Res_Registered", description ="TC_0010_CP_ConfirmationPg_SingleProd_Verify_ClickingOnBookingId_NavigatesTo_ReservationDetails_Res_Registered")
	public void ssp_TC_0010_CP_ConfirmationPg_SingleProd_Verify_ClickingOnBookingId_NavigatesTo_ReservationDetails_Res_Registered(Hashtable<String, String> data)throws Throwable {
