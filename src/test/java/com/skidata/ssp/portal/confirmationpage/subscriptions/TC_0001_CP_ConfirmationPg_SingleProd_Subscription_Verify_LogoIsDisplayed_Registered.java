...
public class TC_0001_CP_ConfirmationPg_SingleProd_Subscription_Verify_LogoIsDisplayed_Registered extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0001_CP_ConfirmationPg_SingleProd_Subscription_Verify_LogoIsDisplayed_Registered.class.getName());

	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0001_CP_ConfirmationPg_SingleProd_Subscription_Verify_LogoIsDisplayed_Registered";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=601,dataProvider = "getDataForTestCaseName", testName = "TC_0001_CP_ConfirmationPg_SingleProd_Subscription_Verify_LogoIsDisplayed_Registered", description ="TC_0001_CP_ConfirmationPg_SingleProd_Subscription_Verify_LogoIsDisplayed_Registered")
	public void ssp_TC_0001_CP_ConfirmationPg_SingleProd_Subscription_Verify_LogoIsDisplayed_Registered(Hashtable<String, String> data)throws Throwable {
...
//				}
			...
			status=sspBookingConfirmationPage.verifyLogoDisplayed();
			Assert.assertEquals(status,data.get("ExpectedValuePASS"),"Logo is not displayed in ConfirmationPage");
