...
public class TC_0006_CP_ConfirmationPg_SingleProd_Res_Verify_BookingConfirmation_EmailMessage_WalletImages_Annonymous extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0006_CP_ConfirmationPg_SingleProd_Res_Verify_BookingConfirmation_EmailMessage_WalletImages_Annonymous.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0006_CP_ConfirmationPg_SingleProd_Res_Verify_BookingConfirmation_EmailMessage_WalletImages_Annonymous";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=606,dataProvider = "getDataForTestCaseName", testName = "TC_0006_CP_ConfirmationPg_SingleProd_Res_Verify_BookingConfirmation_EmailMessage_WalletImages_Annonymous", description ="TC_0006_CP_ConfirmationPg_SingleProd_Res_Verify_BookingConfirmation_EmailMessage_WalletImages_Annonymous")
	public void ssp_TC_0006_CP_ConfirmationPg_SingleProd_Res_Verify_BookingConfirmation_EmailMessage_WalletImages_Annonymous(Hashtable<String, String> data)throws Throwable {
