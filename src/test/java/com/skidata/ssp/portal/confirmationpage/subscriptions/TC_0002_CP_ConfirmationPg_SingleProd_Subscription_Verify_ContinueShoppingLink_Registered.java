...
public class TC_0002_CP_ConfirmationPg_SingleProd_Subscription_Verify_ContinueShoppingLink_Registered extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0002_CP_ConfirmationPg_SingleProd_Subscription_Verify_ContinueShoppingLink_Registered.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0002_CP_ConfirmationPg_SingleProd_Subscription_Verify_ContinueShoppingLink_Registered";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=602,dataProvider = "getDataForTestCaseName", testName = "TC_0002_CP_ConfirmationPg_SingleProd_Subscription_Verify_ContinueShoppingLink_Registered", description ="TC_0002_CP_ConfirmationPg_SingleProd_Subscription_Verify_ContinueShoppingLink_Registered")
	public void ssp_TC_0002_CP_ConfirmationPg_SingleProd_Subscription_Verify_ContinueShoppingLink_Registered(Hashtable<String, String> data)throws Throwable {
