...
public class TC_0006_CP_ConfirmationPg_SingleProd_Verify_BookingConfirmation_EmailMessage_WalletImages_Registered extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0006_CP_ConfirmationPg_SingleProd_Verify_BookingConfirmation_EmailMessage_WalletImages_Registered.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0006_CP_ConfirmationPg_SingleProd_Verify_BookingConfirmation_EmailMessage_WalletImages_Registered";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=506,dataProvider = "getDataForTestCaseName", testName = "TC_0006_CP_ConfirmationPg_SingleProd_Verify_BookingConfirmation_EmailMessage_WalletImages_Registered", description ="TC_0006_CP_ConfirmationPg_SingleProd_Verify_BookingConfirmation_EmailMessage_WalletImages_Registered")
	public void ssp_TC_0006_CP_ConfirmationPg_SingleProd_Verify_BookingConfirmation_EmailMessage_WalletImages_Registered(Hashtable<String, String> data)throws Throwable {
