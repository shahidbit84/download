...
public class TC_0003_CP_ConfirmationPg_SingleProd_Verify_ThankYouMsg_Res_Success_Annonymous extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0003_CP_ConfirmationPg_SingleProd_Verify_ThankYouMsg_Res_Success_Annonymous.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0003_CP_ConfirmationPg_SingleProd_Verify_ThankYouMsg_Res_Success_Annonymous";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=603,dataProvider = "getDataForTestCaseName", testName = "TC_0003_CP_ConfirmationPg_SingleProd_Verify_ThankYouMsg_Res_Success_Annonymous", description ="TC_0003_CP_ConfirmationPg_SingleProd_Verify_ThankYouMsg_Res_Success_Annonymous")
	public void ssp_TC_0003_CP_ConfirmationPg_SingleProd_Verify_ThankYouMsg_Res_Success_Annonymous(Hashtable<String, String> data)throws Throwable {
