...
public class TC_0004_CP_ConfirmationPg_SingleProd_Res_Verify_QRCodeGenerated_Annonymous extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0004_CP_ConfirmationPg_SingleProd_Res_Verify_QRCodeGenerated_Annonymous.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0004_CP_ConfirmationPg_SingleProd_Res_Verify_QRCodeGenerated_Annonymous";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=604,dataProvider = "getDataForTestCaseName", testName = "TC_0004_CP_ConfirmationPg_SingleProd_Res_Verify_QRCodeGenerated_Annonymous", description ="TC_0004_CP_ConfirmationPg_SingleProd_Res_Verify_QRCodeGenerated_Annonymous")
	public void ssp_TC_0004_CP_ConfirmationPg_SingleProd_Res_Verify_QRCodeGenerated_Annonymous(Hashtable<String, String> data)throws Throwable {
