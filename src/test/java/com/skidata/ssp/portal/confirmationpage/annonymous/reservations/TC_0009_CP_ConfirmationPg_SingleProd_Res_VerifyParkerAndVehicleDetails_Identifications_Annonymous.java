...
public class TC_0009_CP_ConfirmationPg_SingleProd_Res_VerifyParkerAndVehicleDetails_Identifications_Annonymous extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0009_CP_ConfirmationPg_SingleProd_Res_VerifyParkerAndVehicleDetails_Identifications_Annonymous.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0009_CP_ConfirmationPg_SingleProd_Res_VerifyParkerAndVehicleDetails_Identifications_Annonymous";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=509,dataProvider = "getDataForTestCaseName", testName = "TC_0009_CP_ConfirmationPg_Verify_ParkerVehicleDetails_GuestUser_Res", description ="TC_0009_CP_ConfirmationPg_Verify_ParkerVehicleDetails_GuestUser_Res")
	public void ssp_TC_0009_CP_ConfirmationPg_Verify_ParkerVehicleDetails_GuestUser_Res(Hashtable<String, String> data)throws Throwable {
...
//			FileUtils.cleanDirectory(new File(System.getProperty("user.dir") + File.separator + "downloadedfiles"));
...
//			sspProductsListPage.addProducts_IntoCart_Reservation_ListView();
			...
			String ID = sspCheckoutPage.addIdentificationDetails_SingleProduct(data.get("Identification1"));
...
//				}
			...
			status=sspBookingConfirmationPage.verifyParkerAndVehicleLabelSection(data.get("Identification1"),data.get("ParkerVehicleLabelHeader"),data.get("ParkerLabel"),data.get("VehicleLabel"),data.get("ParkerName"),UniqueEmailId,ID);
			Assert.assertEquals(status,data.get("ExpectedValuePASS"),"Mismatch in Parker&Vehicle details section");

			status=sspBookingConfirmationPage.verifyIdentificationLabelSection(ID,data.get("IdentificationLabel"),data.get("AccessMediaTypeLabel"),data.get("IDNumberLabel"),data.get("Identification1"));		
			Assert.assertEquals(status,data.get("ExpectedValuePASS"),"Mismatch in Identification details section");
