...
public class TC_0001_CP_ConfirmationPg_SingleProd_Verify_LogoIsDisplayed_Annonymous extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0001_CP_ConfirmationPg_SingleProd_Verify_LogoIsDisplayed_Annonymous.class.getName());

	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0001_CP_ConfirmationPg_SingleProd_Verify_LogoIsDisplayed_Annonymous";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=601,dataProvider = "getDataForTestCaseName", testName = "TC_0001_CP_ConfirmationPg_SingleProd_Verify_LogoIsDisplayed_Annonymous", description ="TC_0001_CP_ConfirmationPg_SingleProd_Verify_LogoIsDisplayed_Annonymous")
	public void ssp_TC_0001_CP_ConfirmationPg_SingleProd_Verify_LogoIsDisplayed_Annonymous(Hashtable<String, String> data)throws Throwable {
