...
public class TC_0004_CP_ConfirmationPg_SingleProd_Subscription_Verify_QRCodeGenerated_Registered extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0004_CP_ConfirmationPg_SingleProd_Subscription_Verify_QRCodeGenerated_Registered.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0004_CP_ConfirmationPg_SingleProd_Subscription_Verify_QRCodeGenerated_Registered";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=604,dataProvider = "getDataForTestCaseName", testName = "TC_0004_CP_ConfirmationPg_SingleProd_Subscription_Verify_QRCodeGenerated_Registered", description ="TC_0004_CP_ConfirmationPg_SingleProd_Subscription_Verify_QRCodeGenerated_Registered")
	public void ssp_TC_0004_CP_ConfirmationPg_SingleProd_Subscription_Verify_QRCodeGenerated_Registered(Hashtable<String, String> data)throws Throwable {
...
//				}
		    ...
		    status=sspBookingConfirmationPage.verifyQRCodeGenerated();
			Assert.assertEquals(status,data.get("ExpectedValuePASS"),"QR code is not generated");
