...
public class TC_0007_CP_ConfirmationPg_SingleProd_Subscription_Verify_DownloadBookingConfirmationLink_Registered extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0007_CP_ConfirmationPg_SingleProd_Subscription_Verify_DownloadBookingConfirmationLink_Registered.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0007_CP_ConfirmationPg_SingleProd_Subscription_Verify_DownloadBookingConfirmationLink_Registered";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=607,dataProvider = "getDataForTestCaseName", testName = "TC_0007_CP_ConfirmationPg_SingleProd_Subscription_Verify_DownloadBookingConfirmationLink_Registered", description ="TC_0007_CP_ConfirmationPg_SingleProd_Subscription_Verify_DownloadBookingConfirmationLink_Registered")
	public void ssp_TC_0007_CP_ConfirmationPg_SingleProd_Subscription_Verify_DownloadBookingConfirmationLink_Registered(Hashtable<String, String> data)throws Throwable {
