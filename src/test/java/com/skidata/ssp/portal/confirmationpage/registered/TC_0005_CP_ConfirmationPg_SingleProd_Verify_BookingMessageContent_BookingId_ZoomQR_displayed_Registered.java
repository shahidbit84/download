...
public class TC_0005_CP_ConfirmationPg_SingleProd_Verify_BookingMessageContent_BookingId_ZoomQR_displayed_Registered extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0005_CP_ConfirmationPg_SingleProd_Verify_BookingMessageContent_BookingId_ZoomQR_displayed_Registered.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0005_CP_ConfirmationPg_SingleProd_Verify_BookingMessageContent_BookingId_ZoomQR_displayed_Registered";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=505,dataProvider = "getDataForTestCaseName", testName = "TC_0005_CP_ConfirmationPg_SingleProd_Verify_BookingMessageContent_BookingId_ZoomQR_displayed_Registered", description ="TC_0005_CP_ConfirmationPg_SingleProd_Verify_BookingMessageContent_BookingId_ZoomQR_displayed_Registered")
	public void ssp_TC_0005_CP_ConfirmationPg_SingleProd_Verify_BookingMessageContent_BookingId_ZoomQR_displayed_Registered(Hashtable<String, String> data)throws Throwable {
...
//				}
			...
			status=sspBookingConfirmationPage.verifyBookingMessageContent_BookingID_ZoomQRCode(data.get("PleaseUseThisIdForAnyCommunication"),data.get("Bookingreferencelabel"),
