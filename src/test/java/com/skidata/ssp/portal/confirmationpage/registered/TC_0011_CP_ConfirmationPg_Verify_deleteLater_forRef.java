...
public class TC_0011_CP_ConfirmationPg_Verify_deleteLater_forRef extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0011_CP_ConfirmationPg_Verify_deleteLater_forRef.class.getName());

	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0011_CP_ConfirmationPg_Verify_deleteLater_forRef";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=511,dataProvider = "getDataForTestCaseName", testName = "TC_0011_CP_ConfirmationPg_Verify_BookingID_Status_Backoffice_Res", description ="TC_0011_CP_ConfirmationPg_Verify_BookingID_Status_Backoffice_Res")
	public void ssp_TC_0011_CP_ConfirmationPg_Verify_deleteLater_forRef(Hashtable<String, String> data)throws Throwable {
