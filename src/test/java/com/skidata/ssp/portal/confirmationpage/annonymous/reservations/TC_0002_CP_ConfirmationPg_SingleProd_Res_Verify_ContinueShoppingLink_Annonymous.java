...
public class TC_0002_CP_ConfirmationPg_SingleProd_Res_Verify_ContinueShoppingLink_Annonymous extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0002_CP_ConfirmationPg_SingleProd_Res_Verify_ContinueShoppingLink_Annonymous.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0002_CP_ConfirmationPg_SingleProd_Res_Verify_ContinueShoppingLink_Annonymous";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=602,dataProvider = "getDataForTestCaseName", testName = "TC_0002_CP_ConfirmationPg_SingleProd_Res_Verify_ContinueShoppingLink_Annonymous", description ="TC_0002_CP_ConfirmationPg_SingleProd_Res_Verify_ContinueShoppingLink_Annonymous")
	public void ssp_TC_0002_CP_ConfirmationPg_SingleProd_Res_Verify_ContinueShoppingLink_Annonymous(Hashtable<String, String> data)throws Throwable {
