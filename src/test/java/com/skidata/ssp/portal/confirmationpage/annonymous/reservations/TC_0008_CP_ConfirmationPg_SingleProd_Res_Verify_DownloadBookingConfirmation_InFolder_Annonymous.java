...
public class TC_0008_CP_ConfirmationPg_SingleProd_Res_Verify_DownloadBookingConfirmation_InFolder_Annonymous extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0008_CP_ConfirmationPg_SingleProd_Res_Verify_DownloadBookingConfirmation_InFolder_Annonymous.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0008_CP_ConfirmationPg_SingleProd_Res_Verify_DownloadBookingConfirmation_InFolder_Annonymous";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=608,dataProvider = "getDataForTestCaseName", testName = "TC_0008_CP_ConfirmationPg_SingleProd_Res_Verify_DownloadBookingConfirmation_InFolder_Annonymous", description ="TC_0008_CP_ConfirmationPg_SingleProd_Res_Verify_DownloadBookingConfirmation_InFolder_Annonymous")
	public void ssp_TC_0008_CP_ConfirmationPg_SingleProd_Res_Verify_DownloadBookingConfirmation_InFolder_Annonymous(Hashtable<String, String> data)throws Throwable {
