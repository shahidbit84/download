...
public class TC_0009_CP_ConfirmationPg_SingleProd_Res_VerifyParkerAndVehicleDetails_IdentificationsDisplayed_Registered extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0009_CP_ConfirmationPg_SingleProd_Res_VerifyParkerAndVehicleDetails_IdentificationsDisplayed_Registered.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0009_CP_ConfirmationPg_SingleProd_Res_VerifyParkerAndVehicleDetails_IdentificationsDisplayed_Registered";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=509,dataProvider = "getDataForTestCaseName", testName = "TC_0009_CP_ConfirmationPg_SingleProd_Res_VerifyParkerAndVehicleDetails_IdentificationsDisplayed_Registered", description ="TC_0009_CP_ConfirmationPg_SingleProd_Res_VerifyParkerAndVehicleDetails_IdentificationsDisplayed_Registered")
	public void ssp_TC_0009_CP_ConfirmationPg_SingleProd_Res_VerifyParkerAndVehicleDetails_IdentificationsDisplayed_Registered(Hashtable<String, String> data)throws Throwable {
