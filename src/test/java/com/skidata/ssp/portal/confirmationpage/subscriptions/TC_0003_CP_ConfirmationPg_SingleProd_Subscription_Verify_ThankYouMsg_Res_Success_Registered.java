...
public class TC_0003_CP_ConfirmationPg_SingleProd_Subscription_Verify_ThankYouMsg_Res_Success_Registered extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0003_CP_ConfirmationPg_SingleProd_Subscription_Verify_ThankYouMsg_Res_Success_Registered.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0003_CP_ConfirmationPg_SingleProd_Subscription_Verify_ThankYouMsg_Res_Success_Registered";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=603,dataProvider = "getDataForTestCaseName", testName = "TC_0003_CP_ConfirmationPg_SingleProd_Subscription_Verify_ThankYouMsg_Res_Success_Registered", description ="TC_0003_CP_ConfirmationPg_SingleProd_Subscription_Verify_ThankYouMsg_Res_Success_Registered")
	public void ssp_TC_0003_CP_ConfirmationPg_SingleProd_Subscription_Verify_ThankYouMsg_Res_Success_Registered(Hashtable<String, String> data)throws Throwable {
...
//				}
			...
			status=sspBookingConfirmationPage.verifyThankyouMessage(data.get("ThankyouMessageHeader"));
			Assert.assertEquals(status,data.get("ExpectedValuePASS"),"Reservation Failed, User in CheckoutPage");
