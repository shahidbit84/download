...
public class TC_0005_CP_ConfirmationPg_SingleProd_Res_Verify_BookingMessageContent_BookingId_ZoomQR_displayed_Annonymous extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0005_CP_ConfirmationPg_SingleProd_Res_Verify_BookingMessageContent_BookingId_ZoomQR_displayed_Annonymous.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0005_CP_ConfirmationPg_SingleProd_Res_Verify_BookingMessageContent_BookingId_ZoomQR_displayed_Annonymous";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=605,dataProvider = "getDataForTestCaseName", testName = "TC_0005_CP_ConfirmationPg_SingleProd_Res_Verify_BookingMessageContent_BookingId_ZoomQR_displayed_Annonymous", description ="TC_0005_CP_ConfirmationPg_SingleProd_Res_Verify_BookingMessageContent_BookingId_ZoomQR_displayed_Annonymous")
	public void ssp_TC_0005_CP_ConfirmationPg_SingleProd_Res_Verify_BookingMessageContent_BookingId_ZoomQR_displayed_Annonymous(Hashtable<String, String> data)throws Throwable {
