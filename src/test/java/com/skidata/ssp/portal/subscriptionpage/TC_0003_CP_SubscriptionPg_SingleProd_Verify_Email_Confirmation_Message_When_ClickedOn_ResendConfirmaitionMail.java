...
public class TC_0003_CP_SubscriptionPg_SingleProd_Verify_Email_Confirmation_Message_When_ClickedOn_ResendConfirmaitionMail extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0003_CP_SubscriptionPg_SingleProd_Verify_Email_Confirmation_Message_When_ClickedOn_ResendConfirmaitionMail.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0003_CP_SubscriptionPg_SingleProd_Verify_Email_Confirmation_Message_When_ClickedOn_ResendConfirmaitionMail";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=512,dataProvider = "getDataForTestCaseName", testName = "TC_0003_CP_SubscriptionPg_SingleProd_Verify_Email_Confirmation_Message_When_ClickedOn_ResendConfirmaitionMail", description ="TC_0003_CP_SubscriptionPg_SingleProd_Verify_Email_Confirmation_Message_When_ClickedOn_ResendConfirmaitionMail")
	public void ssp_TC_0003_CP_SubscriptionPg_SingleProd_Verify_Email_Confirmation_Message_When_ClickedOn_ResendConfirmaitionMail(Hashtable<String, String> data)throws Throwable {
