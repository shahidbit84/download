...
public class TC_0004_CP_SubscriptionPg_SingleProd_Verify_CancellationMessage_Displayed_When_ClickOn_CancelSubscription extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0004_CP_SubscriptionPg_SingleProd_Verify_CancellationMessage_Displayed_When_ClickOn_CancelSubscription.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0004_CP_SubscriptionPg_SingleProd_Verify_CancellationMessage_Displayed_When_ClickOn_CancelSubscription";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=512,dataProvider = "getDataForTestCaseName", testName = "TC_0004_CP_SubscriptionPg_SingleProd_Verify_CancellationMessage_Displayed_When_ClickOn_CancelSubscription", description ="TC_0004_CP_SubscriptionPg_SingleProd_Verify_CancellationMessage_Displayed_When_ClickOn_CancelSubscription")
	public void ssp_TC_0004_CP_SubscriptionPg_SingleProd_Verify_CancellationMessage_Displayed_When_ClickOn_CancelSubscription(Hashtable<String, String> data)throws Throwable {
