...
public class TC_0002_CP_SubscriptionPg_SingleProd_Verify_LabelAndHeader_After_ClickOnView_Subscription extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0002_CP_SubscriptionPg_SingleProd_Verify_LabelAndHeader_After_ClickOnView_Subscription.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0002_CP_SubscriptionPg_SingleProd_Verify_LabelAndHeader_After_ClickOnView_Subscription";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=512,dataProvider = "getDataForTestCaseName", testName = "TC_0002_CP_SubscriptionPg_SingleProd_Verify_LabelAndHeader_After_ClickOnView_Subscription", description ="TC_0002_CP_SubscriptionPg_SingleProd_Verify_LabelAndHeader_After_ClickOnView_Subscription")
	public void ssp_TC_0002_CP_SubscriptionPg_SingleProd_Verify_LabelAndHeader_After_ClickOnView_Subscription(Hashtable<String, String> data)throws Throwable {
