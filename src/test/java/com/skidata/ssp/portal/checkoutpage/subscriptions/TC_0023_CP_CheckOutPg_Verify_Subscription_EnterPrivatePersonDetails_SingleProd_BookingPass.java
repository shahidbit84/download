...
public class TC_0023_CP_CheckOutPg_Verify_Subscription_EnterPrivatePersonDetails_SingleProd_BookingPass extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0023_CP_CheckOutPg_Verify_Subscription_EnterPrivatePersonDetails_SingleProd_BookingPass.class.getName());

	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0023_CP_CheckOutPg_Verify_Subscription_EnterPrivatePersonDetails_SingleProd_BookingPass";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=435,dataProvider = "getDataForTestCaseName", testName = "TC_0023_CP_CheckOutPg_Verify_Subscription_EnterPrivatePersonDetails_SingleProd_BookingPass", description ="TC_0023_CP_CheckOutPg_Verify_Subscription_EnterPrivatePersonDetails_SingleProd_BookingPass")
	public void ssp_TC_0023_CP_CheckOutPg_Verify_Subscription_EnterPrivatePersonDetails_SingleProd_BookingPass(Hashtable<String, String> data)throws Throwable {
