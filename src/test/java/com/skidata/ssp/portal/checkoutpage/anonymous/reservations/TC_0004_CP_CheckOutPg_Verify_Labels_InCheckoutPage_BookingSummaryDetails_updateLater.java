...
public class TC_0004_CP_CheckOutPg_Verify_Labels_InCheckoutPage_BookingSummaryDetails_updateLater extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0004_CP_CheckOutPg_Verify_Labels_InCheckoutPage_BookingSummaryDetails_updateLater.class.getName());

	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0004_CP_CheckOutPg_Verify_Labels_InCheckoutPage_BookingSummaryDetails_updateLater";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=404,dataProvider = "getDataForTestCaseName", testName = "TC_0004_CP_CheckOutPg_Verify_Labels_InCheckoutPage_BookingSummaryDetails_updateLater", description ="TC_0004_CP_CheckOutPg_Verify_Labels_InCheckoutPage_BookingSummaryDetails_updateLater")
	public void ssp_TC_0004_CP_CheckOutPg_Verify_Labels_InCheckoutPage_BookingSummaryDetails_updateLater(Hashtable<String, String> data)throws Throwable {
		...
		try {
			...
			status=sspCheckoutPage.verifyLabelsInCheckoutPageBookingSummary(data.get("BookingsummaryLabel"),data.get("ValueAddedTaxesLabel"),data.get("TotalLabel"),data.get("BackToCartLabel"));
			Assert.assertEquals(status,data.get("ExpectedValuePASS"),"Mismatch in the Labels in the Booking summary");
			//End of Test Case
