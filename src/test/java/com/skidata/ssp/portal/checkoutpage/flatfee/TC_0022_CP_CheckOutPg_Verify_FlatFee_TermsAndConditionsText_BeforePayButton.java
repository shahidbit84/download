...
public class TC_0022_CP_CheckOutPg_Verify_FlatFee_TermsAndConditionsText_BeforePayButton extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0022_CP_CheckOutPg_Verify_FlatFee_TermsAndConditionsText_BeforePayButton.class.getName());

	public String status=null;
	DataUtil dataUtil = new DataUtil();
	WaitHelper wh;

	String testName = "TC_0022_CP_CheckOutPg_Verify_FlatFee_TermsAndConditionsText_BeforePayButton";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=426,dataProvider = "getDataForTestCaseName", testName = "TC_0022_CP_CheckOutPg_Verify_FlatFee_TermsAndConditionsText_BeforePayButton", description ="TC_0022_CP_CheckOutPg_Verify_FlatFee_TermsAndConditionsText_BeforePayButton")
	public void ssp_TC_0022_CP_CheckOutPg_Verify_FlatFee_TermsAndConditionsText_BeforePayButton(Hashtable<String, String> data)throws Throwable {
