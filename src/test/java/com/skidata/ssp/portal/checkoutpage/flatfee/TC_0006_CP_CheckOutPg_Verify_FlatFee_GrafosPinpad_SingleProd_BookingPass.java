...
public class TC_0006_CP_CheckOutPg_Verify_FlatFee_GrafosPinpad_SingleProd_BookingPass extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0006_CP_CheckOutPg_Verify_FlatFee_GrafosPinpad_SingleProd_BookingPass.class.getName());

	public String status=null;
	DataUtil dataUtil = new DataUtil();
	WaitHelper wh ;

	String testName = "TC_0006_CP_CheckOutPg_Verify_FlatFee_GrafosPinpad_SingleProd_BookingPass";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=430,dataProvider = "getDataForTestCaseName", testName = "TC_0006_CP_CheckOutPg_Verify_FlatFee_GrafosPinpad_SingleProd_BookingPass", description ="TC_0006_CP_CheckOutPg_Verify_FlatFee_GrafosPinpad_SingleProd_BookingPass")
	public void ssp_TC_0006_CP_CheckOutPg_Verify_FlatFee_GrafosPinpad_SingleProd_BookingPass(Hashtable<String, String> data)throws Throwable {
