...
public class TC_0024_CP_CheckOutPg_Verify_Res_TermsAndConditionsText_BeforePayButton_Resistered extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0024_CP_CheckOutPg_Verify_Res_TermsAndConditionsText_BeforePayButton_Resistered.class.getName());

	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0024_CP_CheckOutPg_Verify_Res_TermsAndConditionsText_BeforePayButton_Resistered";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=3446,dataProvider = "getDataForTestCaseName", testName = "TC_0024_CP_CheckOutPg_Verify_Res_TermsAndConditionsText_BeforePayButton_Resistered", description ="TC_0024_CP_CheckOutPg_Verify_Res_TermsAndConditionsText_BeforePayButton_Resistered")
	public void ssp_TC_0024_CP_CheckOutPg_Verify_Res_TermsAndConditionsText_BeforePayButton_Resistereds(Hashtable<String, String> data)throws Throwable {
