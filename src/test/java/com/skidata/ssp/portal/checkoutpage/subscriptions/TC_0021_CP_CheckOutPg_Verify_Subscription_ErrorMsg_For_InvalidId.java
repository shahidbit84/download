...
public class TC_0021_CP_CheckOutPg_Verify_Subscription_ErrorMsg_For_InvalidId extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0021_CP_CheckOutPg_Verify_Subscription_ErrorMsg_For_InvalidId.class.getName());

	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0021_CP_CheckOutPg_Verify_Subscription_ErrorMsg_For_InvalidId";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=426,dataProvider = "getDataForTestCaseName", testName = "TC_0021_CP_CheckOutPg_Verify_Subscription_ErrorMsg_For_InvalidId", description ="TC_0021_CP_CheckOutPg_Verify_Subscription_ErrorMsg_For_InvalidId")
	public void ssp_TC_0021_CP_CheckOutPg_Verify_Subscription_ErrorMsg_For_InvalidId(Hashtable<String, String> data)throws Throwable {
