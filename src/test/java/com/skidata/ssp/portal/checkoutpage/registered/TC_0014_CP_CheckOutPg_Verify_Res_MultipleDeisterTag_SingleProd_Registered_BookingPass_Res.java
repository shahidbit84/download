...
public class TC_0014_CP_CheckOutPg_Verify_Res_MultipleDeisterTag_SingleProd_Registered_BookingPass_Res extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0014_CP_CheckOutPg_Verify_Res_MultipleDeisterTag_SingleProd_Registered_BookingPass_Res.class.getName());

	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0014_CP_CheckOutPg_Verify_Res_MultipleDeisterTag_SingleProd_Registered_BookingPass_Res";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=410,dataProvider = "getDataForTestCaseName", testName = "TC_0014_CP_CheckOutPg_Verify_Res_MultipleDeisterTag_SingleProd_Registered_BookingPass_Res", description ="TC_0014_CP_CheckOutPg_Verify_Res_MultipleDeisterTag_SingleProd_Registered_BookingPass_Res")
	public void ssp_TC_0014_CP_CheckOutPg_Verify_Res_MultipleDeisterTag_SingleProd_Registered_BookingPass_Res(Hashtable<String, String> data)throws Throwable {
