...
public class TC_0025_CP_CheckOutPg_Verify_Res_AddAdressDetails_SingleProd_BookingPass_Registered extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0025_CP_CheckOutPg_Verify_Res_AddAdressDetails_SingleProd_BookingPass_Registered.class.getName());

	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0025_CP_CheckOutPg_Verify_Res_AddAdressDetails_SingleProd_BookingPass_Registered";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=431,dataProvider = "getDataForTestCaseName", testName = "TC_0025_CP_CheckOutPg_Verify_Res_AddAdressDetails_SingleProd_BookingPass_Registered", description ="TC_0025_CP_CheckOutPg_Verify_Res_AddAdressDetails_SingleProd_BookingPass_Registered")
	public void ssp_TC_0025_CP_CheckOutPg_Verify_Res_AddAdressDetails_SingleProd_BookingPass_Registered(Hashtable<String, String> data)throws Throwable {
