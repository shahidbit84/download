...
public class TC_0029_CP_CheckOutPg_Verify_Res_EnterCompanyDetailsManually_SingleProd_Registered_BookingPass extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0029_CP_CheckOutPg_Verify_Res_EnterCompanyDetailsManually_SingleProd_Registered_BookingPass.class.getName());

	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0029_CP_CheckOutPg_Verify_Res_EnterCompanyDetailsManually_SingleProd_Registered_BookingPass";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=434,dataProvider = "getDataForTestCaseName", testName = "TC_0029_CP_CheckOutPg_Verify_Res_EnterCompanyDetailsManually_SingleProd_Registered_BookingPass", description ="TC_0029_CP_CheckOutPg_Verify_Res_EnterCompanyDetailsManually_SingleProd_Registered_BookingPass")
