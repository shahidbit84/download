...
public class TC_0035_CP_CheckOutPg_Verify_Res_ParkerSaved_in_MyParkersPg_AfterSuccessBooking_SingleProd_Registered extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0035_CP_CheckOutPg_Verify_Res_ParkerSaved_in_MyParkersPg_AfterSuccessBooking_SingleProd_Registered.class.getName());

	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0035_CP_CheckOutPg_Verify_Res_ParkerSaved_in_MyParkersPg_AfterSuccessBooking_SingleProd_Registered";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=440,dataProvider = "getDataForTestCaseName", testName = "TC_0035_CP_CheckOutPg_Verify_Res_ParkerSaved_in_MyParkersPg_AfterSuccessBooking_SingleProd_Registered", description ="TC_0035_CP_CheckOutPg_Verify_Res_ParkerSaved_in_MyParkersPg_AfterSuccessBooking_SingleProd_Registered")
	public void ssp_TC_0035_CP_CheckOutPg_Verify_Res_ParkerSaved_in_MyParkersPg_AfterSuccessBooking_SingleProd_Registered(Hashtable<String, String> data)throws Throwable {
...
//				}
			...
			status=myParkersPage.verify_AddedParkerDetails(data.get("ParkerName"), UniqueEmailIdParker,data.get("Identification1"),ID);
		    Assert.assertEquals(status,data.get("ExpectedValuePASS"),"Mismatch in the Parker details displayed In MyParkers Page");
