...
public class TC_0020_CP_CheckOutPg_Verify_Res_AddAndDeleteIdentifications_SingleProd_Registered_WarningMessageDisplayed extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0020_CP_CheckOutPg_Verify_Res_AddAndDeleteIdentifications_SingleProd_Registered_WarningMessageDisplayed.class.getName());

	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0020_CP_CheckOutPg_Verify_Res_AddAndDeleteIdentifications_SingleProd_Registered_WarningMessageDisplayed";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=405,dataProvider = "getDataForTestCaseName", testName = "TC_0020_CP_CheckOutPg_Verify_Res_AddAndDeleteIdentifications_SingleProd_Registered_WarningMessageDisplayed", description ="TC_0020_CP_CheckOutPg_Verify_Res_AddAndDeleteIdentifications_SingleProd_Registered_WarningMessageDisplayed")
	public void ssp_TC_0020_CP_CheckOutPg_Verify_Res_AddAndDeleteIdentifications_SingleProd_Registered_WarningMessageDisplayed(Hashtable<String, String> data)throws Throwable {
