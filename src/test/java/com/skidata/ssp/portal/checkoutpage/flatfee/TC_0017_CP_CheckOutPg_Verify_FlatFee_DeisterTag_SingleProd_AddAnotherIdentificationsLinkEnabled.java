...
public class TC_0017_CP_CheckOutPg_Verify_FlatFee_DeisterTag_SingleProd_AddAnotherIdentificationsLinkEnabled extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0017_CP_CheckOutPg_Verify_FlatFee_DeisterTag_SingleProd_AddAnotherIdentificationsLinkEnabled.class.getName());

	public String status=null;
	DataUtil dataUtil = new DataUtil();
	WaitHelper wh;

	String testName = "TC_0017_CP_CheckOutPg_Verify_FlatFee_DeisterTag_SingleProd_AddAnotherIdentificationsLinkEnabled";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=426,dataProvider = "getDataForTestCaseName", testName = "TC_0017_CP_CheckOutPg_Verify_FlatFee_DeisterTag_SingleProd_AddAnotherIdentificationsLinkEnabled", description ="TC_0017_CP_CheckOutPg_Verify_FlatFee_DeisterTag_SingleProd_AddAnotherIdentificationsLinkEnabled")
	public void ssp_TC_0017_CP_CheckOutPg_Verify_FlatFee_DeisterTag_SingleProd_AddAnotherIdentificationsLinkEnabled(Hashtable<String, String> data)throws Throwable {
