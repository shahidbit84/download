...
public class TC_0027_CP_CheckOutPg_Verify_Subscription_EnterPrivatePersonDetails_SingleProd_SavedInProfile extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0027_CP_CheckOutPg_Verify_Subscription_EnterPrivatePersonDetails_SingleProd_SavedInProfile.class.getName());

	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0027_CP_CheckOutPg_Verify_Subscription_EnterPrivatePersonDetails_SingleProd_SavedInProfile";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=435,dataProvider = "getDataForTestCaseName", testName = "TC_0027_CP_CheckOutPg_Verify_Subscription_EnterPrivatePersonDetails_SingleProd_SavedInProfile", description ="TC_0027_CP_CheckOutPg_Verify_Subscription_EnterPrivatePersonDetails_SingleProd_SavedInProfile")
	public void ssp_TC_0027_CP_CheckOutPg_Verify_Subscription_EnterPrivatePersonDetails_SingleProd_SavedInProfile(Hashtable<String, String> data)throws Throwable {
