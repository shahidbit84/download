...
public class TC_0033_CP_CheckOutPg_Verify_Res_SuccessBooking_AfterAddingIamNotTheParker_And_CompanyDetails_SingleProd_Registered extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0033_CP_CheckOutPg_Verify_Res_SuccessBooking_AfterAddingIamNotTheParker_And_CompanyDetails_SingleProd_Registered.class.getName());

	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0033_CP_CheckOutPg_Verify_Res_SuccessBooking_AfterAddingIamNotTheParker_And_CompanyDetails_SingleProd_Registered";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=438,dataProvider = "getDataForTestCaseName", testName = "TC_0033_CP_CheckOutPg_Verify_Res_SuccessBooking_AfterAddingIamNotTheParker_And_CompanyDetails_SingleProd_Registered2", description ="TC_0033_CP_CheckOutPg_Verify_Res_SuccessBooking_AfterAddingIamNotTheParker_And_CompanyDetails_SingleProd_Registered2")
	public void ssp_TC_0033_CP_CheckOutPg_Verify_Res_SuccessBooking_AfterAddingIamNotTheParker_And_CompanyDetails_SingleProd_Registered(Hashtable<String, String> data)throws Throwable {
