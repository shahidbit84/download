...
public class TC_0020_CP_CheckOutPg_Verify_FlatFee_AddAndDeleteIdentifications_SingleProd_WarningMessageDisplayed extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0020_CP_CheckOutPg_Verify_FlatFee_AddAndDeleteIdentifications_SingleProd_WarningMessageDisplayed.class.getName());

	public String status=null;
	DataUtil dataUtil = new DataUtil();
	WaitHelper wh;

	String testName = "TC_0020_CP_CheckOutPg_Verify_FlatFee_AddAndDeleteIdentifications_SingleProd_WarningMessageDisplayed";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=426,dataProvider = "getDataForTestCaseName", testName = "TC_0020_CP_CheckOutPg_Verify_FlatFee_AddAndDeleteIdentifications_SingleProd_WarningMessageDisplayed", description ="TC_0020_CP_CheckOutPg_Verify_FlatFee_AddAndDeleteIdentifications_SingleProd_WarningMessageDisplayed")
	public void ssp_TC_0020_CP_CheckOutPg_Verify_FlatFee_AddAndDeleteIdentifications_SingleProd_WarningMessageDisplayed(Hashtable<String, String> data)throws Throwable {
