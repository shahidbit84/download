...
public class TC_0011_CP_CheckOutPg_Verify_Res_Skidata_SingleProd_Registered_AddAnotherIdentificationsLinkEnabled extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0011_CP_CheckOutPg_Verify_Res_Skidata_SingleProd_Registered_AddAnotherIdentificationsLinkEnabled.class.getName());

	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0011_CP_CheckOutPg_Verify_Res_Skidata_SingleProd_Registered_AddAnotherIdentificationsLinkEnabled";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=409,dataProvider = "getDataForTestCaseName", testName = "TC_0011_CP_CheckOutPg_Verify_Res_Skidata_SingleProd_Registered_AddAnotherIdentificationsLinkEnabled", description ="TC_0011_CP_CheckOutPg_Verify_Res_Skidata_SingleProd_Registered_AddAnotherIdentificationsLinkEnabled")
	public void ssp_TC_0011_CP_CheckOutPg_Verify_Res_Skidata_SingleProd_Registered_AddAnotherIdentificationsLinkEnabled(Hashtable<String, String> data)throws Throwable {
