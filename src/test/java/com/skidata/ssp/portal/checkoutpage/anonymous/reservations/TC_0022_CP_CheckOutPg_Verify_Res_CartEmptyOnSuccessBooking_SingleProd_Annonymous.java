...
public class TC_0022_CP_CheckOutPg_Verify_Res_CartEmptyOnSuccessBooking_SingleProd_Annonymous extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0022_CP_CheckOutPg_Verify_Res_CartEmptyOnSuccessBooking_SingleProd_Annonymous.class.getName());

	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0022_CP_CheckOutPg_Verify_Res_CartEmptyOnSuccessBooking_SingleProd_Annonymous";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=405,dataProvider = "getDataForTestCaseName", testName = "TC_0022_CP_CheckOutPg_Verify_Res_CartEmptyOnSuccessBooking_SingleProd_Annonymous", description ="TC_0022_CP_CheckOutPg_Verify_Res_CartEmptyOnSuccessBooking_SingleProd_Annonymous")
	public void ssp_TC_0022_CP_CheckOutPg_Verify_Res_CartEmptyOnSuccessBooking_SingleProd_Annonymous(Hashtable<String, String> data)throws Throwable {
