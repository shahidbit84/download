...
public class TC_0023_CP_CheckOutPg_Verify_Res_SingleProd_Annonymous_ErrorMsg_For_InValidID extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0023_CP_CheckOutPg_Verify_Res_SingleProd_Annonymous_ErrorMsg_For_InValidID.class.getName());

	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0023_CP_CheckOutPg_Verify_Res_SingleProd_Annonymous_ErrorMsg_For_InValidID";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=405,dataProvider = "getDataForTestCaseName", testName = "TC_0023_CP_CheckOutPg_Verify_Res_SingleProd_Annonymous_ErrorMsg_For_InValidID", description ="TC_0023_CP_CheckOutPg_Verify_Res_SingleProd_Annonymous_ErrorMsg_For_InValidID")
	public void ssp_TC_0023_CP_CheckOutPg_Verify_Res_SingleProd_Annonymous_ErrorMsg_For_InValidID(Hashtable<String, String> data)throws Throwable {
