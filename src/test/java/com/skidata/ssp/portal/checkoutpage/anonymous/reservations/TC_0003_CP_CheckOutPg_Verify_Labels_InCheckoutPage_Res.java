...
public class TC_0003_CP_CheckOutPg_Verify_Labels_InCheckoutPage_Res extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0003_CP_CheckOutPg_Verify_Labels_InCheckoutPage_Res.class.getName());

	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0003_CP_CheckOutPg_Verify_Labels_InCheckoutPage_Res";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=403,dataProvider = "getDataForTestCaseName", testName = "TC_0003_CP_CheckOutPg_Verify_Labels_InCheckoutPage_Res", description ="TC_0003_CP_CheckOutPg_Verify_Labels_InCheckoutPage_Res")
	public void ssp_TC_0003_CP_CheckOutPg_Verify_Labels_InCheckoutPage_Res(Hashtable<String, String> data)throws Throwable {
