...
public class TC_0029_CP_CheckOutPg_Verify_FlatFee_EnterCompanyDetails_SingleProd_SavedInProfile extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0029_CP_CheckOutPg_Verify_FlatFee_EnterCompanyDetails_SingleProd_SavedInProfile.class.getName());

	public String status=null;
	DataUtil dataUtil = new DataUtil();
	WaitHelper wh;

	String testName = "TC_0029_CP_CheckOutPg_Verify_FlatFee_EnterCompanyDetails_SingleProd_SavedInProfile";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=435,dataProvider = "getDataForTestCaseName", testName = "TC_0029_CP_CheckOutPg_Verify_FlatFee_EnterCompanyDetails_SingleProd_SavedInProfile", description ="TC_0029_CP_CheckOutPg_Verify_FlatFee_EnterCompanyDetails_SingleProd_SavedInProfile")
	public void ssp_TC_0029_CP_CheckOutPg_Verify_FlatFee_EnterCompanyDetails_SingleProd_SavedInProfile(Hashtable<String, String> data)throws Throwable {
