...
public class TC_0023_CP_CheckOutPg_Verify_Res_SingleProd_Registered_ErrorMsgInValidID extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0023_CP_CheckOutPg_Verify_Res_SingleProd_Registered_ErrorMsgInValidID.class.getName());

	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0023_CP_CheckOutPg_Verify_Res_SingleProd_Registered_ErrorMsgInValidID";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=405,dataProvider = "getDataForTestCaseName", testName = "TC_0023_CP_CheckOutPg_Verify_Res_SingleProd_Registered_ErrorMsgInValidID", description ="TC_0023_CP_CheckOutPg_Verify_Res_SingleProd_Registered_ErrorMsgInValidID")
	public void ssp_TC_0023_CP_CheckOutPg_Verify_Res_SingleProd_Registered_ErrorMsgInValidID(Hashtable<String, String> data)throws Throwable {
