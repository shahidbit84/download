...
public class TC_0031_CP_CheckOutPg_Verify_Res_SuccessBooking_AfterClickingOnIamNotTheParker_SingleProd_Registered extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0031_CP_CheckOutPg_Verify_Res_SuccessBooking_AfterClickingOnIamNotTheParker_SingleProd_Registered.class.getName());

	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0031_CP_CheckOutPg_Verify_Res_SuccessBooking_AfterClickingOnIamNotTheParker_SingleProd_Registered";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=436,dataProvider = "getDataForTestCaseName", testName = "TC_0031_CP_CheckOutPg_Verify_Res_SuccessBooking_AfterClickingOnIamNotTheParker_SingleProd_Registered", description ="TC_0031_CP_CheckOutPg_Verify_Res_SuccessBooking_AfterClickingOnIamNotTheParker_SingleProd_Registered")
	public void ssp_TC_0031_CP_CheckOutPg_Verify_Res_SuccessBooking_AfterClickingOnIamNotTheParker_SingleProd_Registered(Hashtable<String, String> data)throws Throwable {
