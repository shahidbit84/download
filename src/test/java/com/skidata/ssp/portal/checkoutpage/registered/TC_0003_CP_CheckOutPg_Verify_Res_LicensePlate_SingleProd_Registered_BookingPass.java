...
public class TC_0003_CP_CheckOutPg_Verify_Res_LicensePlate_SingleProd_Registered_BookingPass extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0003_CP_CheckOutPg_Verify_Res_LicensePlate_SingleProd_Registered_BookingPass.class.getName());

	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0003_CP_CheckOutPg_Verify_Res_LicensePlate_SingleProd_Registered_BookingPass";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=407,dataProvider = "getDataForTestCaseName", testName = "TC_0003_CP_CheckOutPg_Verify_Res_LicensePlate_SingleProd_Registered_BookingPass", description ="TC_0003_CP_CheckOutPg_Verify_Res_LicensePlate_SingleProd_Registered_BookingPass")
	public void ssp_TC_0003_CP_CheckOutPg_Verify_Res_LicensePlate_SingleProd_Registered_BookingPass(Hashtable<String, String> data)throws Throwable {
