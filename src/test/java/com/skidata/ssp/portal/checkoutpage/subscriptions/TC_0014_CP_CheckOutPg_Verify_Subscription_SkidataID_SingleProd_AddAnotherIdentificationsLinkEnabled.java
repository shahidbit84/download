...
public class TC_0014_CP_CheckOutPg_Verify_Subscription_SkidataID_SingleProd_AddAnotherIdentificationsLinkEnabled extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0014_CP_CheckOutPg_Verify_Subscription_SkidataID_SingleProd_AddAnotherIdentificationsLinkEnabled.class.getName());

	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0014_CP_CheckOutPg_Verify_Subscription_SkidataID_SingleProd_AddAnotherIdentificationsLinkEnabled";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=426,dataProvider = "getDataForTestCaseName", testName = "TC_0014_CP_CheckOutPg_Verify_Subscription_SkidataID_SingleProd_AddAnotherIdentificationsLinkEnabled", description ="TC_0014_CP_CheckOutPg_Verify_Subscription_SkidataID_SingleProd_AddAnotherIdentificationsLinkEnabled")
	public void ssp_TC_0014_CP_CheckOutPg_Verify_Subscription_SkidataID_SingleProd_AddAnotherIdentificationsLinkEnabled(Hashtable<String, String> data)throws Throwable {
