...
public class TC_0025_CP_CheckOutPg_Verify_FlatFee_EnterCompanyDetails_SingleProd_BookingPass extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0025_CP_CheckOutPg_Verify_FlatFee_EnterCompanyDetails_SingleProd_BookingPass.class.getName());

	public String status=null;
	DataUtil dataUtil = new DataUtil();
	WaitHelper wh;

	String testName = "TC_0025_CP_CheckOutPg_Verify_FlatFee_EnterCompanyDetails_SingleProd_BookingPass";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=435,dataProvider = "getDataForTestCaseName", testName = "TC_0025_CP_CheckOutPg_Verify_FlatFee_EnterCompanyDetails_SingleProd_BookingPass", description ="TC_0025_CP_CheckOutPg_Verify_FlatFee_EnterCompanyDetails_SingleProd_BookingPass")
	public void ssp_TC_0025_CP_CheckOutPg_Verify_FlatFee_EnterCompanyDetails_SingleProd_BookingPass(Hashtable<String, String> data)throws Throwable {
