...
public class TC_0011_CP_MyParkersPg_Verify_Add_Parker_AndClickCancel_ChangesNotSaved extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0011_CP_MyParkersPg_Verify_Add_Parker_AndClickCancel_ChangesNotSaved.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0011_CP_MyParkersPg_Verify_Add_Parker_AndClickCancel_ChangesNotSaved";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=1211,dataProvider = "getDataForTestCaseName", testName = "TC_0011_CP_MyParkersPg_Verify_Add_Parker_AndClickCancel_ChangesNotSaved", description ="TC_0011_CP_MyParkersPg_Verify_Add_Parker_AndClickCancel_ChangesNotSaved")
	public void ssp_TC_0011_CP_MyParkersPg_Verify_Add_Parker_AndClickCancel_ChangesNotSaved(Hashtable<String, String> data)throws Throwable {
