...
public class TC_0005_CP_MyParkersPg_Verify_By_Adding_Name_And_Email_In_ParkerDetails extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0005_CP_MyParkersPg_Verify_By_Adding_Name_And_Email_In_ParkerDetails.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0005_CP_MyParkersPg_Verify_By_Adding_Name_And_Email_In_ParkerDetails";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=1205,dataProvider = "getDataForTestCaseName", testName = "TC_0005_CP_MyParkersPg_Verify_By_Adding_Name_And_Email_In_ParkerDetails", description ="TC_0005_CP_MyParkersPg_Verify_By_Adding_Name_And_Email_In_ParkerDetails")
	public void ssp_TC_0005_CP_MyParkersPg_Verify_By_Adding_Name_And_Email_In_ParkerDetails(Hashtable<String, String> data)throws Throwable {
