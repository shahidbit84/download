...
public class TC_0009_CP_MyParkersPg_Verify_DeleteParker_Success extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0009_CP_MyParkersPg_Verify_DeleteParker_Success.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0009_CP_MyParkersPg_Verify_DeleteParker_Success";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=1209,dataProvider = "getDataForTestCaseName", testName = "TC_0009_CP_MyParkersPg_Verify_DeleteParker_Success", description ="TC_0009_CP_MyParkersPg_Verify_DeleteParker_Success")
	public void ssp_TC_0009_CP_MyParkersPg_Verify_DeleteParker_Success(Hashtable<String, String> data)throws Throwable {
