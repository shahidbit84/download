...
public class TC_0002_CP_MyParkersPg_Verify_LabelsAndLink extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0002_CP_MyParkersPg_Verify_LabelsAndLink.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0002_CP_MyParkersPg_Verify_LabelsAndLink";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=1202,dataProvider = "getDataForTestCaseName", testName = "TC_0002_CP_MyParkersPg_Verify_LabelsAndLink", description ="TC_0002_CP_MyParkersPg_Verify_LabelsAndLink")
	public void ssp_TC_0002_CP_MyParkersPg_Verify_LabelsAndLink(Hashtable<String, String> data)throws Throwable {
