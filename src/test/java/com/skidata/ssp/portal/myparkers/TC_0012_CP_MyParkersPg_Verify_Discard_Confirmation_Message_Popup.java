...
public class TC_0012_CP_MyParkersPg_Verify_Discard_Confirmation_Message_Popup extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0012_CP_MyParkersPg_Verify_Discard_Confirmation_Message_Popup.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0012_CP_MyParkersPg_Verify_Discard_Confirmation_Message_Popup";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=1212,dataProvider = "getDataForTestCaseName", testName = "TC_0012_CP_MyParkersPg_Verify_Discard_Confirmation_Message_Popup", description ="TC_0012_CP_MyParkersPg_Verify_Discard_Confirmation_Message_Popup")
	public void ssp_TC_0012_CP_MyParkersPg_Verify_Discard_Confirmation_Message_Popup(Hashtable<String, String> data)throws Throwable {
