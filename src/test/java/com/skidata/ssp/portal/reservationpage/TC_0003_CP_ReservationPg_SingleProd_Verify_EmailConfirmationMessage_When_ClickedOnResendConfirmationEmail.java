...
public class TC_0003_CP_ReservationPg_SingleProd_Verify_EmailConfirmationMessage_When_ClickedOnResendConfirmationEmail extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0003_CP_ReservationPg_SingleProd_Verify_EmailConfirmationMessage_When_ClickedOnResendConfirmationEmail.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0003_CP_ReservationPg_SingleProd_Verify_EmailConfirmationMessage_When_ClickedOnResendConfirmationEmail";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=512,dataProvider = "getDataForTestCaseName", testName = "TC_0003_CP_ReservationPg_SingleProd_Verify_EmailConfirmationMessage_When_ClickedOnResendConfirmationEmail", description ="TC_0003_CP_ReservationPg_SingleProd_Verify_EmailConfirmationMessage_When_ClickedOnResendConfirmationEmail")
	public void ssp_TC_0003_CP_ReservationPg_SingleProd_Verify_EmailConfirmationMessage_When_ClickedOnResendConfirmationEmail(Hashtable<String, String> data)throws Throwable {
