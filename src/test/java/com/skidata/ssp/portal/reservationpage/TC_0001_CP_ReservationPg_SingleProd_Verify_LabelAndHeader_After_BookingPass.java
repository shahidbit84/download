...
public class TC_0001_CP_ReservationPg_SingleProd_Verify_LabelAndHeader_After_BookingPass extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0001_CP_ReservationPg_SingleProd_Verify_LabelAndHeader_After_BookingPass.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0001_CP_ReservationPg_SingleProd_Verify_LabelAndHeader_After_BookingPass";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=511,dataProvider = "getDataForTestCaseName", testName = "TC_0001_CP_ReservationPg_SingleProd_Verify_LabelAndHeader_After_BookingPass", description ="TC_0001_CP_ReservationPg_SingleProd_Verify_LabelAndHeader_After_BookingPass")
	public void ssp_TC_0001_CP_ReservationPg_SingleProd_Verify_LabelAndHeader_After_BookingPass(Hashtable<String, String> data)throws Throwable {
