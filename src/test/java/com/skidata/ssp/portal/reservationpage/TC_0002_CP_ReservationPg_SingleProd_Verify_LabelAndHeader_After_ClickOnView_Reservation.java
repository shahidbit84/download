...
public class TC_0002_CP_ReservationPg_SingleProd_Verify_LabelAndHeader_After_ClickOnView_Reservation extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0002_CP_ReservationPg_SingleProd_Verify_LabelAndHeader_After_ClickOnView_Reservation.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0002_CP_ReservationPg_SingleProd_Verify_LabelAndHeader_After_ClickOnView_Reservation";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=512,dataProvider = "getDataForTestCaseName", testName = "TC_0002_CP_ReservationPg_SingleProd_Verify_LabelAndHeader_After_ClickOnView_Reservation", description ="TC_0002_CP_ReservationPg_SingleProd_Verify_LabelAndHeader_After_ClickOnView_Reservation")
	public void ssp_TC_0002_CP_ReservationPg_SingleProd_Verify_LabelAndHeader_After_ClickOnView_Reservation(Hashtable<String, String> data)throws Throwable {
