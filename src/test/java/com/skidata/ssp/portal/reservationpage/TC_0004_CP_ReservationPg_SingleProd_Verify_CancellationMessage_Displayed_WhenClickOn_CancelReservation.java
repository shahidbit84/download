...
public class TC_0004_CP_ReservationPg_SingleProd_Verify_CancellationMessage_Displayed_WhenClickOn_CancelReservation extends TestBase {

	public static final Logger log = Logger.getLogger(TC_0004_CP_ReservationPg_SingleProd_Verify_CancellationMessage_Displayed_WhenClickOn_CancelReservation.class.getName());
	public String status=null;
	DataUtil dataUtil = new DataUtil();

	String testName = "TC_0004_CP_ReservationPg_SingleProd_Verify_CancellationMessage_Displayed_WhenClickOn_CancelReservation";
	...
	@Test(groups = {"smoke,regression"},timeOut=800000,priority=512,dataProvider = "getDataForTestCaseName", testName = "TC_0004_CP_ReservationPg_SingleProd_Verify_CancellationMessage_Displayed_WhenClickOn_CancelReservation", description ="TC_0004_CP_ReservationPg_SingleProd_Verify_CancellationMessage_Displayed_WhenClickOn_CancelReservation")
	public void ssp_TC_0004_CP_ReservationPg_SingleProd_Verify_CancellationMessage_Displayed_WhenClickOn_CancelReservation(Hashtable<String, String> data)throws Throwable {
