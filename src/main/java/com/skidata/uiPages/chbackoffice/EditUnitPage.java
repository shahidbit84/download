 ...
 * 
 */
public class EditUnitPage extends TestBase {
	...
	public static final Logger log = Logger.getLogger(EditUnitPage.class.getName());



	//Class constructor
	public EditUnitPage(WebDriver driver,ExtentTest test) {
		this.driver = driver;
		this.test=test;
	...
	@FindBy(xpath = "//div[contains(@v-label,'SSPUnits.UnitsForm-representatives')]/div/div//span[text()='--- Select ---']")
	public WebElement representatives_dropdown;
	...
	@FindBy(xpath = "//li[@id='ssp_units_edit_save']")
	public WebElement Save;
	
	@FindBy(xpath = "//li[@id='ssp_units_edit_cancel']")
	public WebElement Cancel;
	
	@FindBy(xpath = "//p[@class='ng-scope' and @translate='SSPUnits.ApplicationHeader-EditUnits']")
	public WebElement EditUnitpageHeader;
	...
	public void selectRepresentatives(String _representatives) throws InterruptedException {
		Thread.sleep(3000);
		driver.findElement(By.xpath("//div[contains(@v-label,'SSPUnits.UnitsForm-representatives')]//span[@class='k-widget k-dropdown k-header ng-scope']")).click();
		WebElement representatives = driver.findElement(By.xpath("//li[text()='"+_representatives+"']"));
		clickElementUsingJavaScript(representatives);
	}

	/**
	 * Click on the edit unit
	 * @throws InterruptedException 
	 * @throws AWTException 
	 */
	public String editUnitDetails(String ParentUnit,String _Name,String _Description,String _representatives,String _BaseLocale,String _BaseCurrency,String _SecondaryCurrency) throws InterruptedException, AWTException {
...
//		mkh.pressTabKeyAndRelease();
		...
		representatives_dropdown.sendKeys(_representatives);
		clickElementUsingJavaScript(representatives_dropdown);
		WebElement representatives =  driver.findElement(By.xpath("//div[contains(@v-label,'SSPUnits.UnitsForm-representatives')]//option[text()='"+_representatives+"']"));
		clickElementUsingJavaScript(representatives);
...
//		pressTab();
	...
	public String verifyEditUnitpageheader(String _editedUnitName) {
status="FAIL";
		
		log("Page header is displayed as "+EditUnitpageHeader.getText());
		log("Edit generic organization unit - '"+_editedUnitName+"'");
		if(EditUnitpageHeader.getText().equals("Edit generic organization unit - '"+_editedUnitName+"'")) {
			
			status="PASS";
			takeScreenShot();
		}
		return _editedUnitName;
