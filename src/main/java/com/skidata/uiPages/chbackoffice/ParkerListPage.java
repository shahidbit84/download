 ...
 * 
 */
public class ParkerListPage extends TestBase {
	...
	public static final Logger log = Logger.getLogger(ParkerListPage.class.getName());



	//Class constructor
	public ParkerListPage(WebDriver driver,ExtentTest test) {
		this.driver = driver;
		this.test=test;
	...
	@FindBy(xpath = "//li[contains(@v-label,'CH.ButtonAdd') and @v-on-click='addCustomer()']")
