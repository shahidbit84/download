 ...
 * 
 */
public class ReportsListPage extends TestBase {
	...
	public static final Logger log = Logger.getLogger(ReportsListPage.class.getName());



	//Class constructor
	public ReportsListPage(WebDriver driver,ExtentTest test) {
		this.driver = driver;
		this.test=test;
